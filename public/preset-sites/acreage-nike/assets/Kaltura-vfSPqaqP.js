import { a as D, b as M, r as S, g as T } from "./index-Drx2P2ym.js";
function E(l, o) {
    ...
    if (typeof s != "string" && !Array.isArray(s)) {
      for (const n in s)
        if (n !== "default" && !(n in l)) {
          ...
          p && Object.defineProperty(l, n, p.get ? p : { enumerable: !0, get: () => s[n] });
        }
    }
  }
    ...
    y = (t, e, r, c) => {
      if ((e && typeof e == "object") || typeof e == "function")
        for (let i of s(e))
          !p.call(t, i) &&
            i !== r &&
            o(t, i, { get: () => e[i], enumerable: !(c = u(e, i)) || c.enumerable });
      return t;
    },
    O = (t, e, r) => (
      (r = t != null ? l(n(t)) : {}),
      y(!t || !t.__esModule ? o(r, "default", { value: t, enumerable: !0 }) : r, t)
    ),
    w = (t) => y(o({}, "__esModule", { value: !0 }), t),
    a = (t, e, r) => (b(t, typeof e != "symbol" ? e + "" : e, r), r),
    f = {};
  (v(f, { default: () => d }), (h = w(f)));
  var _ = O(D()),
    m = M(),
...
var g = x();
const N = T(g),
  C = E({ __proto__: null, default: N }, [g]);
export { C as K };
