import { a as w, _ as D, r as j, g as C } from "./index-RPEafS1D.js";
function S(p, o) {
    ...
    if (typeof a != "string" && !Array.isArray(a)) {
      for (const u in a)
        if (u !== "default" && !(u in p)) {
          ...
          h && Object.defineProperty(p, u, h.get ? h : { enumerable: !0, get: () => a[u] });
        }
    }
  }
...
function B() {
  ...
  var p = Object.create,
    ...
    k = (r, e, t) =>
      e in r ? o(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (r[e] = t),
    x = (r, e) => {
    ...
    P = (r, e, t, i) => {
      if ((e && typeof e == "object") || typeof e == "function")
        for (let s of a(e))
          !h.call(r, s) &&
            s !== t &&
            o(r, s, { get: () => e[s], enumerable: !(i = l(e, s)) || i.enumerable });
      return r;
    },
    M = (r, e, t) => (
      (t = r != null ? p(u(r)) : {}),
      P(!r || !r.__esModule ? o(t, "default", { value: r, enumerable: !0 }) : t, r)
    ),
    O = (r) => P(o({}, "__esModule", { value: !0 }), r),
  ...
  class v extends E.Component {
    ...
    render() {
      const {
        ...
        b = { width: g === "auto" ? g : "100%", height: _ === "auto" ? _ : "100%" };
      return (
        s === !1 && (b["--controls"] = "none"),
...
var I = B();
const T = C(I),
  U = S({ __proto__: null, default: T }, [I]);
export { U as M };
