import { a as q, b as G, r as X, g as W } from "./index-Drx2P2ym.js";
function z(u, h) {
    ...
    if (typeof p != "string" && !Array.isArray(p)) {
      for (const d in p)
        if (d !== "default" && !(d in u)) {
          ...
          y && Object.defineProperty(u, d, y.get ? y : { enumerable: !0, get: () => p[d] });
        }
    }
  }
...
function J() {
  ...
  var u = Object.create,
    ...
    I = (s, e, t) =>
      e in s ? h(s, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (s[e] = t),
    D = (s, e) => {
    ...
    b = (s, e, t, r) => {
      if ((e && typeof e == "object") || typeof e == "function")
        for (let o of p(e))
          !y.call(s, o) &&
            o !== t &&
            h(s, o, { get: () => e[o], enumerable: !(r = f(e, o)) || r.enumerable });
      return s;
    },
    w = (s, e, t) => (
      (t = s != null ? u(d(s)) : {}),
      b(!s || !s.__esModule ? h(t, "default", { value: s, enumerable: !0 }) : t, s)
    ),
  ...
  const E = typeof navigator < "u",
    k = E && navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1,
    O = E && (/iPad|iPhone|iPod/.test(navigator.userAgent) || k) && !window.MSStream,
    U = E && /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && !window.MSStream,
    F = "https://cdn.jsdelivr.net/npm/hls.js@VERSION/dist/hls.min.js",
    N = "Hls",
    j = "https://cdnjs.cloudflare.com/ajax/libs/dashjs/VERSION/dash.all.min.js",
    H = "dashjs",
  ...
  class g extends P.Component {
    constructor() {
      (super(...arguments),
        ...
        i(this, "renderTrack", (e, t) => P.default.createElement("track", { key: t, ...e })),
        i(this, "ref", (e) => {
    ...
    shouldUseHLS(e) {
      return (U && this.props.config.forceSafariHLS) || this.props.config.forceHLS
        ? !0
          ...
          (0, a.getSDK)(j.replace("VERSION", o), H).then((n) => {
            ((this.dash = n.MediaPlayer().create()),
              ...
              parseInt(o) < 3
                ...
                : this.dash.updateSettings({ debug: { logLevel: n.Debug.LOG_LEVEL_NONE } }),
              this.props.onLoaded());
          }),
        this.shouldUseFLV(e) &&
    ...
    render() {
      const {
        ...
        K = { width: l === "auto" ? l : "100%", height: c === "auto" ? c : "100%" };
