var $n = (function () {
  ...
  return function (t) {
    ...
    var B = {},
      z;
    for (z in t) t.hasOwnProperty(z) && (B[z] = t[z]);
    var ve = "./this.program",
      nn = !0,
      F = "";
    function _n(e) {
    ...
    var on;
    (typeof document < "u" && document.currentScript && (F = document.currentScript.src),
      be && (F = be),
      F.indexOf("blob:") !== 0
        ? (F = F.substr(0, F.replace(/[?#].*/, "").lastIndexOf("/") + 1))
        : (F = ""));
    var an = t.print || console.log.bind(console),
      L = t.printErr || console.warn.bind(console);
    for (z in B) B.hasOwnProperty(z) && (t[z] = B[z]);
    ((B = null),
      t.arguments && t.arguments,
      t.thisProgram && (ve = t.thisProgram),
      t.quit && t.quit);
    function pn(e, r) {
      if (typeof WebAssembly.Function == "function") {
        for (
          var n = { i: "i32", j: "i64", f: "f32", d: "f64" },
            i = { parameters: [], results: r[0] == "v" ? [] : [n[r[0]]] },
            p = 1;
          p < r.length;
          ++p
        )
      ...
      d.push(f.length);
      for (var p = 0; p < f.length; ++p) d.push(w[f[p]]);
      ...
      var Y = new Uint8Array(
        ...
        oe = new WebAssembly.Module(Y),
        ae = new WebAssembly.Instance(oe, { e: { f: e } }),
        M = ae.exports.f;
      return M;
    }
    var Ce = [],
    ...
    function un(e, r) {
      if ((Q || ((Q = new WeakMap()), cn(0, U.length)), Q.has(e))) return Q.get(e);
      var n = sn();
      try {
        Ee(n, e);
      } catch (p) {
    ...
    function Pe(e, r, n) {
      ...
      if (p - r > 16 && e.subarray && Ae) return Ae.decode(e.subarray(r, p));
      for (var d = ""; r < p;) {
        var m = e[r++];
        if (!(m & 128)) {
    ...
    function mn(e) {
      for (var r = 0, n = 0; n < e.length; ++n) {
        ...
        (i >= 55296 &&
          i <= 57343 &&
          (i = (65536 + ((i & 1023) << 10)) | (e.charCodeAt(++n) & 1023)),
          i <= 127 ? ++r : i <= 2047 ? (r += 2) : i <= 65535 ? (r += 3) : (r += 4));
      }
      return r;
    }
    function fn(e, r) {
    ...
    function dn(e, r, n) {
      for (var i = 0; i < e.length; ++i) V[r++ >> 0] = e.charCodeAt(i);
      V[r >> 0] = 0;
    }
    function yn(e, r) {
    ...
    function Re(e) {
      try {
        if (e == j && q) return new Uint8Array(q);
    ...
    function Dn() {
      return !q && nn && typeof fetch == "function"
    ...
    function Sn() {
      ...
      function p() {
        return !q &&
          ...
          ? fetch(j, { credentials: "same-origin" }).then(function (m) {
              var f = WebAssembly.instantiateStreaming(m, e);
              return f.then(n, function (w) {
                return (
                  L("wasm streaming compile failed: " + w),
    ...
    function Fn(e) {
      ...
      for (var i = 1; i <= 4; i *= 2) {
        ...
        var d = Math.min(n, yn(Math.max(e, p), 65536)),
          m = Tn(d);
        if (m) return !0;
      }
      return !1;
    ...
    function Z() {
      if (!Z.strings) {
        ...
        for (var n in fe) fe[n] === void 0 ? delete r[n] : (r[n] = fe[n]);
        var i = [];
    ...
    function Hn(e, r, n, i) {
      for (var p = 0, d = 0; d < n; d++) {
        var m = y[r >> 2],
          f = y[(r + 4) >> 2];
        r += 8;
        for (var w = 0; w < f; w++) I.printChar(e, G[m + w]);
        p += f;
      }
      return ((y[i >> 2] = p), 0);
    }
    ...
    function _e(e, r) {
      for (var n = new Date(e.getTime()); r > 0;) {
        var i = te(n.getFullYear()),
          p = n.getMonth(),
          d = (i ? re : ne)[p];
        if (r > d - n.getDate())
          ((r -= d - n.getDate() + 1),
            n.setDate(1),
            p < 11 ? n.setMonth(p + 1) : (n.setMonth(0), n.setFullYear(n.getFullYear() + 1)));
    ...
    function Ln(e, r, n, i) {
      ...
      for (var w in f) m = m.replace(new RegExp(w, "g"), f[w]);
      ...
      function ae(a, s, A) {
        for (var b = typeof a == "number" ? a.toString() : a || ""; b.length < s;) b = A[0] + b;
        return b;
      }
      function M(a, s) {
        return ae(a, s, "0");
      ...
      function k(a, s) {
        ...
        var b;
        return (
          (b = A(a.getFullYear() - s.getFullYear())) === 0 &&
            (b = A(a.getMonth() - s.getMonth())) === 0 &&
            (b = A(a.getDate() - s.getDate())),
          b
        );
      }
      function pe(a) {
      ...
      function tn(a) {
        var s = _e(new Date(a.tm_year + 1900, 0, 1), a.tm_yday),
          A = new Date(s.getFullYear(), 0, 4),
          b = new Date(s.getFullYear() + 1, 0, 4),
          T = pe(A),
          x = pe(b);
        return k(T, s) <= 0
          ? k(x, s) <= 0
...
`;
        ...
        "%U": function (a) {
          var s = new Date(a.tm_year + 1900, 0, 1),
            A = s.getDay() === 0 ? s : _e(s, 7 - s.getDay()),
            b = new Date(a.tm_year + 1900, a.tm_mon, a.tm_mday);
          if (k(A, b) < 0) {
            var T = de(te(b.getFullYear()) ? re : ne, b.getMonth() - 1) - 31,
              x = 31 - A.getDate(),
              H = x + T + b.getDate();
        ...
        "%V": function (a) {
          var s = new Date(a.tm_year + 1900, 0, 4),
            A = new Date(a.tm_year + 1901, 0, 4),
            b = pe(s),
            T = pe(A),
            x = _e(new Date(a.tm_year + 1900, 0, 1), a.tm_yday);
          if (k(x, b) < 0) return "53";
          if (k(T, x) <= 0) return "01";
          var H;
          return (
            b.getFullYear() < a.tm_year + 1900
              ? (H = a.tm_yday + 32 - b.getDate())
              : (H = a.tm_yday + 1 - b.getDate()),
            M(Math.ceil(H / 7), 2)
          );
        },
        "%w": function (a) {
        ...
        "%W": function (a) {
          var s = new Date(a.tm_year, 0, 1),
            A = s.getDay() === 1 ? s : _e(s, s.getDay() === 0 ? 1 : 7 - s.getDay() + 1),
            b = new Date(a.tm_year + 1900, a.tm_mon, a.tm_mday);
          if (k(A, b) < 0) {
            var T = de(te(b.getFullYear()) ? re : ne, b.getMonth() - 1) - 31,
              x = 31 - A.getDate(),
      ...
      for (var w in rn) m.includes(w) && (m = m.replace(new RegExp(w, "g"), rn[w](d)));
      var ge = Un(m);
    ...
    var Te = (t._emscripten_bind_VoidPtr___destroy___0 = function () {
      ...
      Ke = (t._emscripten_bind_rcConfig_get_walkableSlopeAngle_0 = function () {
        return (Ke = t._emscripten_bind_rcConfig_get_walkableSlopeAngle_0 = t.asm.G).apply(
          null,
          arguments,
        );
      }),
      Ze = (t._emscripten_bind_rcConfig_set_walkableSlopeAngle_1 = function () {
        return (Ze = t._emscripten_bind_rcConfig_set_walkableSlopeAngle_1 = t.asm.H).apply(
          null,
          arguments,
        );
      }),
      $e = (t._emscripten_bind_rcConfig_get_walkableHeight_0 = function () {
        return ($e = t._emscripten_bind_rcConfig_get_walkableHeight_0 = t.asm.I).apply(
          null,
          arguments,
        );
      }),
      et = (t._emscripten_bind_rcConfig_set_walkableHeight_1 = function () {
        return (et = t._emscripten_bind_rcConfig_set_walkableHeight_1 = t.asm.J).apply(
          null,
          arguments,
        );
      }),
      tt = (t._emscripten_bind_rcConfig_get_walkableClimb_0 = function () {
        return (tt = t._emscripten_bind_rcConfig_get_walkableClimb_0 = t.asm.K).apply(
          null,
          arguments,
        );
      }),
      rt = (t._emscripten_bind_rcConfig_set_walkableClimb_1 = function () {
        return (rt = t._emscripten_bind_rcConfig_set_walkableClimb_1 = t.asm.L).apply(
          null,
          arguments,
        );
      }),
      nt = (t._emscripten_bind_rcConfig_get_walkableRadius_0 = function () {
        return (nt = t._emscripten_bind_rcConfig_get_walkableRadius_0 = t.asm.M).apply(
          null,
          arguments,
        );
      }),
      _t = (t._emscripten_bind_rcConfig_set_walkableRadius_1 = function () {
        return (_t = t._emscripten_bind_rcConfig_set_walkableRadius_1 = t.asm.N).apply(
          null,
          arguments,
        );
      }),
      ...
      at = (t._emscripten_bind_rcConfig_get_maxSimplificationError_0 = function () {
        return (at = t._emscripten_bind_rcConfig_get_maxSimplificationError_0 = t.asm.Q).apply(
          null,
          arguments,
        );
      }),
      pt = (t._emscripten_bind_rcConfig_set_maxSimplificationError_1 = function () {
        return (pt = t._emscripten_bind_rcConfig_set_maxSimplificationError_1 = t.asm.R).apply(
          null,
          arguments,
        );
      }),
      st = (t._emscripten_bind_rcConfig_get_minRegionArea_0 = function () {
        return (st = t._emscripten_bind_rcConfig_get_minRegionArea_0 = t.asm.S).apply(
          null,
          arguments,
        );
      }),
      ct = (t._emscripten_bind_rcConfig_set_minRegionArea_1 = function () {
        return (ct = t._emscripten_bind_rcConfig_set_minRegionArea_1 = t.asm.T).apply(
          null,
          arguments,
        );
      }),
      ut = (t._emscripten_bind_rcConfig_get_mergeRegionArea_0 = function () {
        return (ut = t._emscripten_bind_rcConfig_get_mergeRegionArea_0 = t.asm.U).apply(
          null,
          arguments,
        );
      }),
      lt = (t._emscripten_bind_rcConfig_set_mergeRegionArea_1 = function () {
        return (lt = t._emscripten_bind_rcConfig_set_mergeRegionArea_1 = t.asm.V).apply(
          null,
          arguments,
        );
      }),
      mt = (t._emscripten_bind_rcConfig_get_maxVertsPerPoly_0 = function () {
        return (mt = t._emscripten_bind_rcConfig_get_maxVertsPerPoly_0 = t.asm.W).apply(
          null,
          arguments,
        );
      }),
      ft = (t._emscripten_bind_rcConfig_set_maxVertsPerPoly_1 = function () {
        return (ft = t._emscripten_bind_rcConfig_set_maxVertsPerPoly_1 = t.asm.X).apply(
          null,
          arguments,
        );
      }),
      dt = (t._emscripten_bind_rcConfig_get_detailSampleDist_0 = function () {
        return (dt = t._emscripten_bind_rcConfig_get_detailSampleDist_0 = t.asm.Y).apply(
          null,
          arguments,
        );
      }),
      yt = (t._emscripten_bind_rcConfig_set_detailSampleDist_1 = function () {
        return (yt = t._emscripten_bind_rcConfig_set_detailSampleDist_1 = t.asm.Z).apply(
          null,
          arguments,
        );
      }),
      gt = (t._emscripten_bind_rcConfig_get_detailSampleMaxError_0 = function () {
        return (gt = t._emscripten_bind_rcConfig_get_detailSampleMaxError_0 = t.asm._).apply(
          null,
          arguments,
        );
      }),
      bt = (t._emscripten_bind_rcConfig_set_detailSampleMaxError_1 = function () {
        return (bt = t._emscripten_bind_rcConfig_set_detailSampleMaxError_1 = t.asm.$).apply(
          null,
          arguments,
        );
      }),
      ...
      Et = (t._emscripten_bind_DebugNavMesh_DebugNavMesh_0 = function () {
        return (Et = t._emscripten_bind_DebugNavMesh_DebugNavMesh_0 = t.asm.na).apply(
          null,
          arguments,
        );
      }),
      Tt = (t._emscripten_bind_DebugNavMesh_getTriangleCount_0 = function () {
        return (Tt = t._emscripten_bind_DebugNavMesh_getTriangleCount_0 = t.asm.oa).apply(
          null,
          arguments,
        );
      }),
      Ft = (t._emscripten_bind_DebugNavMesh_getTriangle_1 = function () {
        return (Ft = t._emscripten_bind_DebugNavMesh_getTriangle_1 = t.asm.pa).apply(
          null,
          arguments,
        );
      }),
      zt = (t._emscripten_bind_DebugNavMesh___destroy___0 = function () {
        return (zt = t._emscripten_bind_DebugNavMesh___destroy___0 = t.asm.qa).apply(
          null,
          arguments,
        );
      }),
      ...
      kt = (t._emscripten_bind_NavmeshData_NavmeshData_0 = function () {
        return (kt = t._emscripten_bind_NavmeshData_NavmeshData_0 = t.asm.sa).apply(
          null,
          arguments,
        );
      }),
      xt = (t._emscripten_bind_NavmeshData_get_dataPointer_0 = function () {
        return (xt = t._emscripten_bind_NavmeshData_get_dataPointer_0 = t.asm.ta).apply(
          null,
          arguments,
        );
      }),
      Wt = (t._emscripten_bind_NavmeshData_set_dataPointer_1 = function () {
        return (Wt = t._emscripten_bind_NavmeshData_set_dataPointer_1 = t.asm.ua).apply(
          null,
          arguments,
        );
      }),
      ...
      Lt = (t._emscripten_bind_NavmeshData___destroy___0 = function () {
        return (Lt = t._emscripten_bind_NavmeshData___destroy___0 = t.asm.xa).apply(
          null,
          arguments,
        );
      }),
      ...
      Bt = (t._emscripten_bind_dtObstacleRef___destroy___0 = function () {
        return (Bt = t._emscripten_bind_dtObstacleRef___destroy___0 = t.asm.Ba).apply(
          null,
          arguments,
        );
      }),
      qt = (t._emscripten_bind_dtCrowdAgentParams_dtCrowdAgentParams_0 = function () {
        return (qt = t._emscripten_bind_dtCrowdAgentParams_dtCrowdAgentParams_0 = t.asm.Ca).apply(
          null,
          arguments,
        );
      }),
      Gt = (t._emscripten_bind_dtCrowdAgentParams_get_radius_0 = function () {
        return (Gt = t._emscripten_bind_dtCrowdAgentParams_get_radius_0 = t.asm.Da).apply(
          null,
          arguments,
        );
      }),
      Jt = (t._emscripten_bind_dtCrowdAgentParams_set_radius_1 = function () {
        return (Jt = t._emscripten_bind_dtCrowdAgentParams_set_radius_1 = t.asm.Ea).apply(
          null,
          arguments,
        );
      }),
      Xt = (t._emscripten_bind_dtCrowdAgentParams_get_height_0 = function () {
        return (Xt = t._emscripten_bind_dtCrowdAgentParams_get_height_0 = t.asm.Fa).apply(
          null,
          arguments,
        );
      }),
      Kt = (t._emscripten_bind_dtCrowdAgentParams_set_height_1 = function () {
        return (Kt = t._emscripten_bind_dtCrowdAgentParams_set_height_1 = t.asm.Ga).apply(
          null,
          arguments,
        );
      }),
      Zt = (t._emscripten_bind_dtCrowdAgentParams_get_maxAcceleration_0 = function () {
        return (Zt = t._emscripten_bind_dtCrowdAgentParams_get_maxAcceleration_0 = t.asm.Ha).apply(
          null,
          arguments,
        );
      }),
      $t = (t._emscripten_bind_dtCrowdAgentParams_set_maxAcceleration_1 = function () {
        return ($t = t._emscripten_bind_dtCrowdAgentParams_set_maxAcceleration_1 = t.asm.Ia).apply(
          null,
          arguments,
        );
      }),
      er = (t._emscripten_bind_dtCrowdAgentParams_get_maxSpeed_0 = function () {
        return (er = t._emscripten_bind_dtCrowdAgentParams_get_maxSpeed_0 = t.asm.Ja).apply(
          null,
          arguments,
        );
      }),
      tr = (t._emscripten_bind_dtCrowdAgentParams_set_maxSpeed_1 = function () {
        return (tr = t._emscripten_bind_dtCrowdAgentParams_set_maxSpeed_1 = t.asm.Ka).apply(
          null,
          arguments,
        );
      }),
      rr = (t._emscripten_bind_dtCrowdAgentParams_get_collisionQueryRange_0 = function () {
        return (rr = t._emscripten_bind_dtCrowdAgentParams_get_collisionQueryRange_0 =
          t.asm.La).apply(null, arguments);
      }),
      nr = (t._emscripten_bind_dtCrowdAgentParams_set_collisionQueryRange_1 = function () {
        return (nr = t._emscripten_bind_dtCrowdAgentParams_set_collisionQueryRange_1 =
          t.asm.Ma).apply(null, arguments);
      }),
      _r = (t._emscripten_bind_dtCrowdAgentParams_get_pathOptimizationRange_0 = function () {
        return (_r = t._emscripten_bind_dtCrowdAgentParams_get_pathOptimizationRange_0 =
          t.asm.Na).apply(null, arguments);
      }),
      ir = (t._emscripten_bind_dtCrowdAgentParams_set_pathOptimizationRange_1 = function () {
        return (ir = t._emscripten_bind_dtCrowdAgentParams_set_pathOptimizationRange_1 =
          t.asm.Oa).apply(null, arguments);
      }),
      or = (t._emscripten_bind_dtCrowdAgentParams_get_separationWeight_0 = function () {
        return (or = t._emscripten_bind_dtCrowdAgentParams_get_separationWeight_0 = t.asm.Pa).apply(
          null,
          arguments,
        );
      }),
      ar = (t._emscripten_bind_dtCrowdAgentParams_set_separationWeight_1 = function () {
        return (ar = t._emscripten_bind_dtCrowdAgentParams_set_separationWeight_1 = t.asm.Qa).apply(
          null,
          arguments,
        );
      }),
      pr = (t._emscripten_bind_dtCrowdAgentParams_get_updateFlags_0 = function () {
        return (pr = t._emscripten_bind_dtCrowdAgentParams_get_updateFlags_0 = t.asm.Ra).apply(
          null,
          arguments,
        );
      }),
      sr = (t._emscripten_bind_dtCrowdAgentParams_set_updateFlags_1 = function () {
        return (sr = t._emscripten_bind_dtCrowdAgentParams_set_updateFlags_1 = t.asm.Sa).apply(
          null,
          arguments,
        );
      }),
      cr = (t._emscripten_bind_dtCrowdAgentParams_get_obstacleAvoidanceType_0 = function () {
        return (cr = t._emscripten_bind_dtCrowdAgentParams_get_obstacleAvoidanceType_0 =
          t.asm.Ta).apply(null, arguments);
      }),
      ur = (t._emscripten_bind_dtCrowdAgentParams_set_obstacleAvoidanceType_1 = function () {
        return (ur = t._emscripten_bind_dtCrowdAgentParams_set_obstacleAvoidanceType_1 =
          t.asm.Ua).apply(null, arguments);
      }),
      lr = (t._emscripten_bind_dtCrowdAgentParams_get_queryFilterType_0 = function () {
        return (lr = t._emscripten_bind_dtCrowdAgentParams_get_queryFilterType_0 = t.asm.Va).apply(
          null,
          arguments,
        );
      }),
      mr = (t._emscripten_bind_dtCrowdAgentParams_set_queryFilterType_1 = function () {
        return (mr = t._emscripten_bind_dtCrowdAgentParams_set_queryFilterType_1 = t.asm.Wa).apply(
          null,
          arguments,
        );
      }),
      fr = (t._emscripten_bind_dtCrowdAgentParams_get_userData_0 = function () {
        return (fr = t._emscripten_bind_dtCrowdAgentParams_get_userData_0 = t.asm.Xa).apply(
          null,
          arguments,
        );
      }),
      dr = (t._emscripten_bind_dtCrowdAgentParams_set_userData_1 = function () {
        return (dr = t._emscripten_bind_dtCrowdAgentParams_set_userData_1 = t.asm.Ya).apply(
          null,
          arguments,
        );
      }),
      yr = (t._emscripten_bind_dtCrowdAgentParams___destroy___0 = function () {
        return (yr = t._emscripten_bind_dtCrowdAgentParams___destroy___0 = t.asm.Za).apply(
          null,
          arguments,
        );
      }),
      ...
      vr = (t._emscripten_bind_NavMesh_buildFromNavmeshData_1 = function () {
        return (vr = t._emscripten_bind_NavMesh_buildFromNavmeshData_1 = t.asm.bb).apply(
          null,
          arguments,
        );
      }),
      ...
      wr = (t._emscripten_bind_NavMesh_freeNavmeshData_1 = function () {
        return (wr = t._emscripten_bind_NavMesh_freeNavmeshData_1 = t.asm.db).apply(
          null,
          arguments,
        );
      }),
      Ar = (t._emscripten_bind_NavMesh_getDebugNavMesh_0 = function () {
        return (Ar = t._emscripten_bind_NavMesh_getDebugNavMesh_0 = t.asm.eb).apply(
          null,
          arguments,
        );
      }),
      Pr = (t._emscripten_bind_NavMesh_getClosestPoint_1 = function () {
        return (Pr = t._emscripten_bind_NavMesh_getClosestPoint_1 = t.asm.fb).apply(
          null,
          arguments,
        );
      }),
      Nr = (t._emscripten_bind_NavMesh_getRandomPointAround_2 = function () {
        return (Nr = t._emscripten_bind_NavMesh_getRandomPointAround_2 = t.asm.gb).apply(
          null,
          arguments,
        );
      }),
      ...
      jr = (t._emscripten_bind_NavMesh_setDefaultQueryExtent_1 = function () {
        return (jr = t._emscripten_bind_NavMesh_setDefaultQueryExtent_1 = t.asm.kb).apply(
          null,
          arguments,
        );
      }),
      Or = (t._emscripten_bind_NavMesh_getDefaultQueryExtent_0 = function () {
        return (Or = t._emscripten_bind_NavMesh_getDefaultQueryExtent_0 = t.asm.lb).apply(
          null,
          arguments,
        );
      }),
      Rr = (t._emscripten_bind_NavMesh_addCylinderObstacle_3 = function () {
        return (Rr = t._emscripten_bind_NavMesh_addCylinderObstacle_3 = t.asm.mb).apply(
          null,
          arguments,
        );
      }),
      ...
      Qr = (t._emscripten_bind_Crowd_getAgentNextTargetPath_1 = function () {
        return (Qr = t._emscripten_bind_Crowd_getAgentNextTargetPath_1 = t.asm.yb).apply(
          null,
          arguments,
        );
      }),
      ...
      Ir = (t._emscripten_bind_Crowd_overOffmeshConnection_1 = function () {
        return (Ir = t._emscripten_bind_Crowd_overOffmeshConnection_1 = t.asm.Ab).apply(
          null,
          arguments,
        );
      }),
      ...
      Gr = (t._emscripten_bind_Crowd_getAgentParameters_1 = function () {
        return (Gr = t._emscripten_bind_Crowd_getAgentParameters_1 = t.asm.Db).apply(
          null,
          arguments,
        );
      }),
      Jr = (t._emscripten_bind_Crowd_setAgentParameters_2 = function () {
        return (Jr = t._emscripten_bind_Crowd_setAgentParameters_2 = t.asm.Eb).apply(
          null,
          arguments,
        );
      }),
      Xr = (t._emscripten_bind_Crowd_setDefaultQueryExtent_1 = function () {
        return (Xr = t._emscripten_bind_Crowd_setDefaultQueryExtent_1 = t.asm.Fb).apply(
          null,
          arguments,
        );
      }),
      Kr = (t._emscripten_bind_Crowd_getDefaultQueryExtent_0 = function () {
        return (Kr = t._emscripten_bind_Crowd_getDefaultQueryExtent_0 = t.asm.Gb).apply(
          null,
          arguments,
        );
      }),
    ...
    function ye(e) {
      if (W > 0 || (gn(), W > 0)) return;
      function r() {
        ie ||
          ((ie = !0),
          (t.calledRun = !0),
          !we && (bn(), he(t), t.onRuntimeInitialized && t.onRuntimeInitialized(), hn()));
      }
      t.setStatus
        ? (t.setStatus("Running..."),
          setTimeout(function () {
    ...
    var g = {
      ...
      prepare: function () {
        if (g.needed) {
          for (var e = 0; e < g.temps.length; e++) t._free(g.temps[e]);
          ((g.temps.length = 0),
            t._free(g.buffer),
            (g.buffer = 0),
            (g.size += g.needed),
      ...
      alloc: function (e, r) {
        ...
        return (
          g.pos + i >= g.size
            ? (ce(i > 0), (g.needed += i), (p = t._malloc(i)), g.temps.push(p))
            : ((p = g.buffer + g.pos), (g.pos += i)),
          p
        );
      },
      copy: function (e, r, n) {
        ...
        for (var p = 0; p < e.length; p++) r[n + p] = e[p];
      },
    };
    function Kn(e) {
      if (typeof e == "object") {
    ...
    ((_.prototype = Object.create(C.prototype)),
      ...
      (_.__cache__ = {}),
      (t.rcConfig = _),
      (_.prototype.get_width = _.prototype.get_width =
        function () {
          var e = this.ptr;
          return ze(e);
        }),
      (_.prototype.set_width = _.prototype.set_width =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_height = _.prototype.get_height =
        function () {
          var e = this.ptr;
          return ke(e);
        }),
      (_.prototype.set_height = _.prototype.set_height =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_tileSize = _.prototype.get_tileSize =
        function () {
          var e = this.ptr;
          return We(e);
        }),
      (_.prototype.set_tileSize = _.prototype.set_tileSize =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_borderSize = _.prototype.get_borderSize =
        function () {
          var e = this.ptr;
          return He(e);
        }),
      (_.prototype.set_borderSize = _.prototype.set_borderSize =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_cs = _.prototype.get_cs =
        function () {
          var e = this.ptr;
          return Qe(e);
        }),
      (_.prototype.set_cs = _.prototype.set_cs =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_ch = _.prototype.get_ch =
        function () {
          var e = this.ptr;
          return Ie(e);
        }),
      (_.prototype.set_ch = _.prototype.set_ch =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_bmin = _.prototype.get_bmin =
        function (e) {
          var r = this.ptr;
          return (e && typeof e == "object" && (e = e.ptr), qe(r, e));
        }),
      (_.prototype.set_bmin = _.prototype.set_bmin =
        function (e, r) {
          var n = this.ptr;
          (g.prepare(),
      ...
      (_.prototype.get_bmax = _.prototype.get_bmax =
        function (e) {
          var r = this.ptr;
          return (e && typeof e == "object" && (e = e.ptr), Je(r, e));
        }),
      (_.prototype.set_bmax = _.prototype.set_bmax =
        function (e, r) {
          var n = this.ptr;
          (g.prepare(),
            e && typeof e == "object" && (e = e.ptr),
      ...
      (_.prototype.get_walkableSlopeAngle = _.prototype.get_walkableSlopeAngle =
        function () {
          var e = this.ptr;
          return Ke(e);
        }),
      (_.prototype.set_walkableSlopeAngle = _.prototype.set_walkableSlopeAngle =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_walkableHeight = _.prototype.get_walkableHeight =
        function () {
          var e = this.ptr;
          return $e(e);
        }),
      (_.prototype.set_walkableHeight = _.prototype.set_walkableHeight =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_walkableClimb = _.prototype.get_walkableClimb =
        function () {
          var e = this.ptr;
          return tt(e);
        }),
      (_.prototype.set_walkableClimb = _.prototype.set_walkableClimb =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_walkableRadius = _.prototype.get_walkableRadius =
        function () {
          var e = this.ptr;
          return nt(e);
        }),
      (_.prototype.set_walkableRadius = _.prototype.set_walkableRadius =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_maxEdgeLen = _.prototype.get_maxEdgeLen =
        function () {
          var e = this.ptr;
          return it(e);
        }),
      (_.prototype.set_maxEdgeLen = _.prototype.set_maxEdgeLen =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_maxSimplificationError = _.prototype.get_maxSimplificationError =
        function () {
          var e = this.ptr;
          return at(e);
        }),
      (_.prototype.set_maxSimplificationError = _.prototype.set_maxSimplificationError =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_minRegionArea = _.prototype.get_minRegionArea =
        function () {
          var e = this.ptr;
          return st(e);
        }),
      (_.prototype.set_minRegionArea = _.prototype.set_minRegionArea =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_mergeRegionArea = _.prototype.get_mergeRegionArea =
        function () {
          var e = this.ptr;
          return ut(e);
        }),
      (_.prototype.set_mergeRegionArea = _.prototype.set_mergeRegionArea =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_maxVertsPerPoly = _.prototype.get_maxVertsPerPoly =
        function () {
          var e = this.ptr;
          return mt(e);
        }),
      (_.prototype.set_maxVertsPerPoly = _.prototype.set_maxVertsPerPoly =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_detailSampleDist = _.prototype.get_detailSampleDist =
        function () {
          var e = this.ptr;
          return dt(e);
        }),
      (_.prototype.set_detailSampleDist = _.prototype.set_detailSampleDist =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.get_detailSampleMaxError = _.prototype.get_detailSampleMaxError =
        function () {
          var e = this.ptr;
          return gt(e);
        }),
      (_.prototype.set_detailSampleMaxError = _.prototype.set_detailSampleMaxError =
        function (e) {
          var r = this.ptr;
      ...
      (_.prototype.__destroy__ = _.prototype.__destroy__ =
        function () {
          var e = this.ptr;
          ht(e);
        }));
    ...
    ((c.prototype = Object.create(C.prototype)),
      ...
      (c.__cache__ = {}),
      (t.Vec3 = c),
      (c.prototype.get_x = c.prototype.get_x =
        function () {
          var e = this.ptr;
          return wt(e);
        }),
      (c.prototype.set_x = c.prototype.set_x =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), At(r, e));
        }),
      Object.defineProperty(c.prototype, "x", { get: c.prototype.get_x, set: c.prototype.set_x }),
      (c.prototype.get_y = c.prototype.get_y =
        function () {
          var e = this.ptr;
          return Pt(e);
        }),
      (c.prototype.set_y = c.prototype.set_y =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), Nt(r, e));
        }),
      Object.defineProperty(c.prototype, "y", { get: c.prototype.get_y, set: c.prototype.set_y }),
      (c.prototype.get_z = c.prototype.get_z =
        function () {
          var e = this.ptr;
          return Dt(e);
        }),
      (c.prototype.set_z = c.prototype.set_z =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), St(r, e));
        }),
      Object.defineProperty(c.prototype, "z", { get: c.prototype.get_z, set: c.prototype.set_z }),
    ...
    ((S.prototype = Object.create(C.prototype)),
      ...
      (S.__cache__ = {}),
      (t.Triangle = S),
      (S.prototype.getPoint = S.prototype.getPoint =
        function (e) {
          var r = this.ptr;
    ...
    ((P.prototype = Object.create(C.prototype)),
      ...
      (P.__cache__ = {}),
      (t.DebugNavMesh = P),
      (P.prototype.getTriangleCount = P.prototype.getTriangleCount =
        function () {
          var e = this.ptr;
          return Tt(e);
        }),
      (P.prototype.getTriangle = P.prototype.getTriangle =
        function (e) {
          var r = this.ptr;
    ...
    ((h.prototype = Object.create(C.prototype)),
      ...
      (h.__cache__ = {}),
      (t.NavmeshData = h),
      (h.prototype.get_dataPointer = h.prototype.get_dataPointer =
        function () {
          var e = this.ptr;
          return xt(e);
        }),
      (h.prototype.set_dataPointer = h.prototype.set_dataPointer =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), Wt(r, e));
        }),
      Object.defineProperty(h.prototype, "dataPointer", {
        get: h.prototype.get_dataPointer,
        set: h.prototype.set_dataPointer,
      }),
      (h.prototype.get_size = h.prototype.get_size =
        function () {
          var e = this.ptr;
          return Yt(e);
        }),
      (h.prototype.set_size = h.prototype.set_size =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), Ht(r, e));
        }),
      Object.defineProperty(h.prototype, "size", {
        get: h.prototype.get_size,
        set: h.prototype.set_size,
      }),
    ...
    ((N.prototype = Object.create(C.prototype)),
      ...
      (N.__cache__ = {}),
      (t.NavPath = N),
      (N.prototype.getPointCount = N.prototype.getPointCount =
        function () {
          var e = this.ptr;
          return Qt(e);
        }),
      (N.prototype.getPoint = N.prototype.getPoint =
        function (e) {
          var r = this.ptr;
    ...
    ((o.prototype = Object.create(C.prototype)),
      ...
      (o.prototype.__class__ = o),
      (o.__cache__ = {}),
      (t.dtCrowdAgentParams = o),
      (o.prototype.get_radius = o.prototype.get_radius =
        function () {
          var e = this.ptr;
          return Gt(e);
        }),
      (o.prototype.set_radius = o.prototype.set_radius =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), Jt(r, e));
        }),
      Object.defineProperty(o.prototype, "radius", {
        get: o.prototype.get_radius,
        set: o.prototype.set_radius,
      }),
      (o.prototype.get_height = o.prototype.get_height =
        function () {
          var e = this.ptr;
          return Xt(e);
        }),
      (o.prototype.set_height = o.prototype.set_height =
        function (e) {
          var r = this.ptr;
      ...
      (o.prototype.get_maxAcceleration = o.prototype.get_maxAcceleration =
        function () {
          var e = this.ptr;
          return Zt(e);
        }),
      (o.prototype.set_maxAcceleration = o.prototype.set_maxAcceleration =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), $t(r, e));
        }),
      Object.defineProperty(o.prototype, "maxAcceleration", {
        get: o.prototype.get_maxAcceleration,
        set: o.prototype.set_maxAcceleration,
      }),
      (o.prototype.get_maxSpeed = o.prototype.get_maxSpeed =
        function () {
          var e = this.ptr;
          return er(e);
        }),
      (o.prototype.set_maxSpeed = o.prototype.set_maxSpeed =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), tr(r, e));
        }),
      Object.defineProperty(o.prototype, "maxSpeed", {
        get: o.prototype.get_maxSpeed,
        set: o.prototype.set_maxSpeed,
      }),
      (o.prototype.get_collisionQueryRange = o.prototype.get_collisionQueryRange =
        function () {
          var e = this.ptr;
          return rr(e);
        }),
      (o.prototype.set_collisionQueryRange = o.prototype.set_collisionQueryRange =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), nr(r, e));
        }),
      Object.defineProperty(o.prototype, "collisionQueryRange", {
        get: o.prototype.get_collisionQueryRange,
        set: o.prototype.set_collisionQueryRange,
      }),
      (o.prototype.get_pathOptimizationRange = o.prototype.get_pathOptimizationRange =
        function () {
          var e = this.ptr;
          return _r(e);
        }),
      (o.prototype.set_pathOptimizationRange = o.prototype.set_pathOptimizationRange =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), ir(r, e));
        }),
      Object.defineProperty(o.prototype, "pathOptimizationRange", {
        get: o.prototype.get_pathOptimizationRange,
        set: o.prototype.set_pathOptimizationRange,
      }),
      (o.prototype.get_separationWeight = o.prototype.get_separationWeight =
        function () {
          var e = this.ptr;
          return or(e);
        }),
      (o.prototype.set_separationWeight = o.prototype.set_separationWeight =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), ar(r, e));
        }),
      Object.defineProperty(o.prototype, "separationWeight", {
        get: o.prototype.get_separationWeight,
        set: o.prototype.set_separationWeight,
      }),
      (o.prototype.get_updateFlags = o.prototype.get_updateFlags =
        function () {
          var e = this.ptr;
          return pr(e);
        }),
      (o.prototype.set_updateFlags = o.prototype.set_updateFlags =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), sr(r, e));
        }),
      Object.defineProperty(o.prototype, "updateFlags", {
        get: o.prototype.get_updateFlags,
        set: o.prototype.set_updateFlags,
      }),
      (o.prototype.get_obstacleAvoidanceType = o.prototype.get_obstacleAvoidanceType =
        function () {
          var e = this.ptr;
          return cr(e);
        }),
      (o.prototype.set_obstacleAvoidanceType = o.prototype.set_obstacleAvoidanceType =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), ur(r, e));
        }),
      Object.defineProperty(o.prototype, "obstacleAvoidanceType", {
        get: o.prototype.get_obstacleAvoidanceType,
        set: o.prototype.set_obstacleAvoidanceType,
      }),
      (o.prototype.get_queryFilterType = o.prototype.get_queryFilterType =
        function () {
          var e = this.ptr;
          return lr(e);
        }),
      (o.prototype.set_queryFilterType = o.prototype.set_queryFilterType =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), mr(r, e));
        }),
      Object.defineProperty(o.prototype, "queryFilterType", {
        get: o.prototype.get_queryFilterType,
        set: o.prototype.set_queryFilterType,
      }),
      (o.prototype.get_userData = o.prototype.get_userData =
        function () {
          var e = this.ptr;
          return v(fr(e), R);
        }),
      (o.prototype.set_userData = o.prototype.set_userData =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), dr(r, e));
        }),
      Object.defineProperty(o.prototype, "userData", {
        get: o.prototype.get_userData,
        set: o.prototype.set_userData,
      }),
      (o.prototype.__destroy__ = o.prototype.__destroy__ =
        function () {
          var e = this.ptr;
    ...
    ((u.prototype = Object.create(C.prototype)),
      ...
      (u.prototype.build = u.prototype.build =
        function (e, r, n, i, p) {
          var d = this.ptr;
          (g.prepare(),
            typeof e == "object" && (e = Zn(e)),
            r && typeof r == "object" && (r = r.ptr),
            typeof n == "object" && (n = Kn(n)),
            i && typeof i == "object" && (i = i.ptr),
            p && typeof p == "object" && (p = p.ptr),
            hr(d, e, r, n, i, p));
        }),
      (u.prototype.buildFromNavmeshData = u.prototype.buildFromNavmeshData =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), vr(r, e));
        }),
      (u.prototype.getNavmeshData = u.prototype.getNavmeshData =
        function () {
          var e = this.ptr;
          return v(Cr(e), h);
        }),
      (u.prototype.freeNavmeshData = u.prototype.freeNavmeshData =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), wr(r, e));
        }),
      (u.prototype.getDebugNavMesh = u.prototype.getDebugNavMesh =
        function () {
          var e = this.ptr;
          return v(Ar(e), P);
        }),
      (u.prototype.getClosestPoint = u.prototype.getClosestPoint =
        function (e) {
          var r = this.ptr;
          return (e && typeof e == "object" && (e = e.ptr), v(Pr(r, e), c));
        }),
      (u.prototype.getRandomPointAround = u.prototype.getRandomPointAround =
        function (e, r) {
          var n = this.ptr;
          return (
            e && typeof e == "object" && (e = e.ptr),
      ...
      (u.prototype.moveAlong = u.prototype.moveAlong =
        function (e, r) {
          var n = this.ptr;
          return (
            e && typeof e == "object" && (e = e.ptr),
      ...
      (u.prototype.getNavMesh = u.prototype.getNavMesh =
        function () {
          var e = this.ptr;
          return v(Sr(e), E);
        }),
      (u.prototype.computePath = u.prototype.computePath =
        function (e, r) {
          var n = this.ptr;
          return (
            e && typeof e == "object" && (e = e.ptr),
      ...
      (u.prototype.setDefaultQueryExtent = u.prototype.setDefaultQueryExtent =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), jr(r, e));
        }),
      (u.prototype.getDefaultQueryExtent = u.prototype.getDefaultQueryExtent =
        function () {
          var e = this.ptr;
          return v(Or(e), c);
        }),
      (u.prototype.addCylinderObstacle = u.prototype.addCylinderObstacle =
        function (e, r, n) {
          var i = this.ptr;
          return (
            e && typeof e == "object" && (e = e.ptr),
      ...
      (u.prototype.addBoxObstacle = u.prototype.addBoxObstacle =
        function (e, r, n) {
          var i = this.ptr;
          return (
            e && typeof e == "object" && (e = e.ptr),
      ...
      (u.prototype.removeObstacle = u.prototype.removeObstacle =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), Tr(r, e));
        }),
    ...
    return (
      ...
      (l.prototype.addAgent = l.prototype.addAgent =
        function (e, r) {
          var n = this.ptr;
          return (
            e && typeof e == "object" && (e = e.ptr),
      ...
      (l.prototype.removeAgent = l.prototype.removeAgent =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), Wr(r, e));
        }),
      (l.prototype.update = l.prototype.update =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), Yr(r, e));
        }),
      (l.prototype.getAgentPosition = l.prototype.getAgentPosition =
        function (e) {
          var r = this.ptr;
          return (e && typeof e == "object" && (e = e.ptr), v(Hr(r, e), c));
        }),
      (l.prototype.getAgentVelocity = l.prototype.getAgentVelocity =
        function (e) {
          var r = this.ptr;
          return (e && typeof e == "object" && (e = e.ptr), v(Lr(r, e), c));
        }),
      (l.prototype.getAgentNextTargetPath = l.prototype.getAgentNextTargetPath =
        function (e) {
          var r = this.ptr;
          return (e && typeof e == "object" && (e = e.ptr), v(Qr(r, e), c));
        }),
      (l.prototype.getAgentState = l.prototype.getAgentState =
        function (e) {
          var r = this.ptr;
          return (e && typeof e == "object" && (e = e.ptr), Ur(r, e));
        }),
      (l.prototype.overOffmeshConnection = l.prototype.overOffmeshConnection =
        function (e) {
          var r = this.ptr;
          return (e && typeof e == "object" && (e = e.ptr), !!Ir(r, e));
        }),
      (l.prototype.agentGoto = l.prototype.agentGoto =
        function (e, r) {
          var n = this.ptr;
          (e && typeof e == "object" && (e = e.ptr),
            r && typeof r == "object" && (r = r.ptr),
      ...
      (l.prototype.agentTeleport = l.prototype.agentTeleport =
        function (e, r) {
          var n = this.ptr;
          (e && typeof e == "object" && (e = e.ptr),
            r && typeof r == "object" && (r = r.ptr),
      ...
      (l.prototype.getAgentParameters = l.prototype.getAgentParameters =
        function (e) {
          var r = this.ptr;
          return (e && typeof e == "object" && (e = e.ptr), v(Gr(r, e), o));
        }),
      (l.prototype.setAgentParameters = l.prototype.setAgentParameters =
        function (e, r) {
          var n = this.ptr;
          (e && typeof e == "object" && (e = e.ptr),
            r && typeof r == "object" && (r = r.ptr),
      ...
      (l.prototype.setDefaultQueryExtent = l.prototype.setDefaultQueryExtent =
        function (e) {
          var r = this.ptr;
          (e && typeof e == "object" && (e = e.ptr), Xr(r, e));
        }),
      (l.prototype.getDefaultQueryExtent = l.prototype.getDefaultQueryExtent =
        function () {
          var e = this.ptr;
          return v(Kr(e), c);
        }),
      (l.prototype.getCorners = l.prototype.getCorners =
        function (e) {
          var r = this.ptr;
