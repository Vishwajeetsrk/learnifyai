...
var br = new Oe(),
  ...
  mn = new Uint8Array([16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15]),
  Lt = new Oe(),
  oe = new Uint8Array(320);
function Tr(e, t, r, n) {
  var a, o;
  for (a = 0; a < r; ++a) e[a] = 0;
...
function ct(e, t) {
  ...
  var r = 0,
    ...
    a = 0,
    o = e.tag;
  do ((n = 2 * n + (o & 1)), (o >>>= 1), ++a, (r += t.table[a]), (n -= t.table[a]));
  while (n >= 0);
...
function Mt(e, t, r) {
  for (;;) {
    ...
    if (n < 256) e.dest[e.destLen++] = n;
      ...
      var a, o, s, u;
      for (
        n -= 257, a = se(e, Et[n], Ct[n]), o = ct(e, r), s = e.destLen - se(e, Er[o], Cr[o]), u = s;
        u < s + a;
        ++u
      )
...
G.prototype.toSVG = function (e) {
  ...
  return (
    ...
    this.fill &&
      this.fill !== "black" &&
      (this.fill === null ? (t += ' fill="none"') : (t += ' fill="' + this.fill + '"')),
...
g.OPERAND = function (e, t) {
  ...
  if (Array.isArray(t))
    for (var n = 0; n < t.length; n += 1)
      (k.argument(e.length === t.length, "Not enough arguments given for type" + t),
...
function Ve(e) {
  e.format === 1
    ? z.call(
        this,
        "coverageTable",
        [{ name: "coverageFormat", type: "USHORT", value: 1 }].concat(Be("glyph", e.glyphs)),
      )
    : e.format === 2
      ? z.call(
          this,
  ...
  z.call(
    ...
    Re("scriptRecord", e, function (t, r) {
      var n = t.script,
        a = n.defaultLangSys;
      return (
        k.assert(!!a, "Unable to write GSUB: script " + t.tag + " has no default language system."),
        [
        ...
        { name: "featureTag" + r, type: "TAG", value: t.tag },
        {
          ...
          value: new z(
            ...
            [{ name: "featureParams", type: "USHORT", value: n.featureParams }].concat(
              Be("lookupListIndex", n.lookupListIndexes),
            ),
          ),
        },
      ];
...
function Ze(e, t) {
  z.call(
    ...
    dt("lookup", e, function (r) {
      ...
      return (
        k.assert(!!n, "Unable to write GSUB lookup type " + r.lookupType + " tables."),
        new z(
          "lookupTable",
          [
...
d.prototype.parseULongList = function (e) {
  ...
  for (
    var t = new Array(e), r = this.data, n = this.offset + this.relativeOffset, a = 0;
    a < e;
    a++
  )
...
d.prototype.parseListOfLists = function (e) {
  for (
    ...
    if (((this.relativeOffset = s), e)) {
      for (var u = this.parseOffset16List(), i = new Array(u.length), p = 0; p < u.length; p++)
...
d.prototype.parseCoverage = function () {
  ...
  if (t === 2) {
    for (var n = new Array(r), a = 0; a < r; a++)
      n[a] = { start: this.parseUShort(), end: this.parseUShort(), index: this.parseUShort() };
...
d.prototype.parseClassDef = function () {
  ...
  if (t === 2)
    return {
      format: 2,
      ranges: this.parseRecordList({ start: d.uShort, end: d.uShort, classId: d.uShort }),
    };
...
d.prototype.parseFeatureList = function () {
  return (
    this.parsePointer(
      d.recordList({
        tag: d.tag,
        feature: d.pointer({ featureParams: d.offset16, lookupListIndexes: d.uShortList }),
      }),
    ) || []
  );
};
...
function Ln(e, t) {
  ...
  for (var n = 0; n < r; n += 1)
    for (var a = t.parseULong(), o = t.parseULong(), s = t.parseULong(), u = a; u <= o; u += 1)
  ...
  for (r = 0; r < i; r += 1) {
    ...
    (m.end <= 65535 && m.start <= 65535
      ? ((l = l.concat({ name: "end_" + r, type: "USHORT", value: m.end })),
        ...
        (f = f.concat({ name: "idRangeOffset_" + r, type: "USHORT", value: m.offset })),
        m.glyphId !== void 0 &&
          (v = v.concat({ name: "glyph_" + r, type: "USHORT", value: m.glyphId })))
      : (p += 1),
      !t &&
        m.glyphIndex !== void 0 &&
        ((x = x.concat({ name: "cmap12Start_" + r, type: "ULONG", value: m.start })),
        (x = x.concat({ name: "cmap12End_" + r, type: "ULONG", value: m.end })),
        (x = x.concat({ name: "cmap12Glyph_" + r, type: "ULONG", value: m.glyphIndex }))));
  }
  if (
    ((o.segCountX2 = (i - p) * 2),
    (o.searchRange = Math.pow(2, Math.floor(Math.log(i - p) / Math.log(2))) * 2),
    ...
    (o.cmap4Length =
      14 + l.length * 2 + 2 + h.length * 2 + c.length * 2 + f.length * 2 + v.length * 2),
    !t)
  ) {
    var y = 16 + x.length * 4;
...
Z.prototype.getPath = function (e, t, r, n, a) {
  ...
  if ((n.hinting && a && a.hinting && (s = this.path && a.hinting.exec(this, r)), s))
    ((o = a.hinting.getCommands(s)), (e = Math.round(e)), (t = Math.round(t)), (u = i = 1));
  else {
  ...
  for (var l = new G(), h = 0; h < o.length; h += 1) {
    ...
    c.type === "M"
      ...
      : c.type === "L"
        ...
        : c.type === "Q"
          ? l.quadraticCurveTo(e + c.x1 * u, t + -c.y1 * i, e + c.x * u, t + -c.y * i)
          : c.type === "C"
            ? l.curveTo(
                e + c.x1 * u,
                t + -c.y1 * i,
...
Z.prototype.drawPoints = function (e, t, r, n) {
  ...
  for (
    var o = (1 / this.path.unitsPerEm) * n, s = [], u = [], i = this.path, p = 0;
    p < i.commands.length;
    p += 1
  ) {
    var l = i.commands[p];
...
Ut.prototype.get = function (e) {
  if (this.glyphs[e] === void 0) {
    ...
    (this.font.cffEncoding
      ...
      : this.font.glyphNames.names && (t.name = this.font.glyphNames.glyphIndexToName(e)),
...
function ea(e) {
  for (var t = {}, r = 0; r < e.length; r += 1) {
    var n = e[r][0],
      a = e[r][1],
      o = void 0;
    if ((a.length === 1 ? (o = a[0]) : (o = a), t.hasOwnProperty(n) && !isNaN(t[n])))
    ...
    if (Array.isArray(s.type)) {
      ...
      for (var i = 0; i < s.type.length; i++)
        ((a = e[s.op] !== void 0 ? e[s.op][i] : void 0),
          a === void 0 && (a = s.value !== void 0 && s.value[i] !== void 0 ? s.value[i] : null),
...
function Wt(e, t, r, n) {
  for (var a = [], o = 0; o < r.length; o += 1) {
    ...
    if (i !== 0 && p !== 0) {
      var l = Ir(e, p + t, i, n);
      if (
        ((u._defaultWidthX = l.defaultWidthX), (u._nominalWidthX = l.nominalWidthX), l.subrs !== 0)
      ) {
        var h = p + l.subrs,
          c = de(e, h + t);
...
function aa(e, t, r) {
  var n,
    ...
    s = o.parseCard8();
  if (s === 0)
    for (var u = o.parseCard8(), i = 0; i < u; i += 1) ((n = o.parseCard8()), (a[n] = i));
  else if (s === 1) {
    var p = o.parseCard8();
    n = 1;
    for (var l = 0; l < p; l += 1)
      for (var h = o.parseCard8(), c = o.parseCard8(), f = h; f <= h + c; f += 1)
        ((a[f] = n), (n += 1));
    ...
    for (var P, Y, j, J, $, M, N, W, q, _, H, V, w = 0; w < T.length;) {
      ...
      switch (((w += 1), X)) {
        ...
        case 5:
          ...
          break;
        case 6:
          for (; i.length > 0 && ((c += i.shift()), u.lineTo(c, f), i.length !== 0);)
            ((f += i.shift()), u.lineTo(c, f));
          break;
        case 7:
          for (; i.length > 0 && ((f += i.shift()), u.lineTo(c, f), i.length !== 0);)
          ...
          switch (((X = T[w]), (w += 1), X)) {
            ...
            case 37:
              ((n = c + i.shift()),
                ...
                (H = q + i.shift()),
                (V = _ + i.shift()),
                Math.abs(H - c) > Math.abs(V - f) ? (c = H + i.shift()) : (f = V + i.shift()),
                u.curveTo(n, a, o, s, N, W),
                u.curveTo(q, _, H, V, c, f));
              break;
            default:
        ...
        default:
          X < 32
            ...
            : X < 247
              ? i.push(X - 139)
              : X < 251
                ? ((P = T[w]), (w += 1), i.push((X - 247) * 256 + P + 108))
                : X < 255
                  ? ((P = T[w]), (w += 1), i.push(-(X - 251) * 256 - P - 108))
                  : ((P = T[w]),
                    (Y = T[w + 1]),
                    (j = T[w + 2]),
                    (J = T[w + 3]),
  ...
  if (u === 0)
    for (var i = 0; i < r; i++) {
      if (((o = s.parseCard8()), o >= n))
        throw new Error(
          "CFF table CID Font FDSelect has bad FD index value " + o + " (FD count " + n + ")",
        );
      a.push(o);
    }
  else if (u === 3) {
...
function sa(e, t, r, n) {
  ...
  if (p.length !== 1)
    throw new Error(
      "CFF table has too many fonts in 'FontSet' - count of fonts NameIndex.length = " + p.length,
    );
  var l = p[0];
  if (
...
function Mr(e, t) {
  ...
  return (
    n >= 0 && (r = n),
    (n = t.indexOf(e)),
    n >= 0 ? (r = n + _e.length) : ((r = _e.length + t.length), t.push(e)),
    r
  );
}
function ia() {
...
function Gr(e, t, r) {
  for (var n = {}, a = 0; a < e.length; a += 1) {
    ...
    s !== void 0 &&
      !Br(s, o.value) &&
      (o.type === "SID" && (s = Mr(s, r)), (n[o.op] = { name: o.name, type: o.type, value: s }));
  }
  return n;
}
function _t(e, t) {
...
function ca(e, t) {
  for (
    var r = new b.Record("Charsets", [{ name: "format", type: "Card8", value: 0 }]), n = 0;
    n < e.length;
    n += 1
  ) {
    var a = e[n],
...
function fa(e) {
  for (
    var t = new b.Record("CharStrings INDEX", [{ name: "charStrings", type: "INDEX", value: [] }]),
      r = 0;
    r < e.length;
    r += 1
  ) {
...
function ga(e, t) {
  ...
  return (
    ...
    k.argument(r.magicNumber === 1594834165, "Font header has wrong magic number."),
...
function ka(e, t) {
  ...
  for (var a = r.parseULong(), o = [], s = 0; s < a; s++) {
    for (var u = "", i = t + r.parseUShort(), p = r.parseUShort(), l = i; l < i + p; ++l)
...
function La(e, t) {
  ...
  for (var s in e) {
    ...
    if ((u === void 0 && (u = s), (r = parseInt(u)), isNaN(r)))
      throw new Error(
        'Name table entry "' + s + '" does not exist, see nameTableNames for complete list.',
      );
    ((a[r] = e[s]), n.push(r));
  }
...
ee[2] = function () {
  var e = this.parseUShort();
  return (
    k.argument(e === 1, "GSUB Multiple Substitution Subtable identifier-format must be 1"),
    { substFormat: e, coverage: this.parsePointer(d.coverage), sequences: this.parseListOfLists() }
  );
};
ee[3] = function () {
  var e = this.parseUShort();
  return (
    k.argument(e === 1, "GSUB Alternate Substitution Subtable identifier-format must be 1"),
    {
      substFormat: e,
      coverage: this.parsePointer(d.coverage),
            ...
            b.tableList("ligature", t, function (r) {
              return new b.Table(
                ...
                [{ name: "ligGlyph", type: "USHORT", value: r.ligGlyph }].concat(
                  b.ushortList("component", r.components, r.components.length + 1),
                ),
              );
            }),
          );
...
ke[6] = function (e) {
  if (e.substFormat === 1) {
          ...
          return new b.Table(
            ...
            b.tableList("chainRule", a, function (o) {
              var s = b
                ...
                .concat(b.ushortList("lookaheadGlyph", o.lookahead, o.lookahead.length))
                .concat(b.ushortList("substitution", [], o.lookupRecords.length));
              return (
                o.lookupRecords.forEach(function (u, i) {
                  s = s
                    .concat({ name: "sequenceIndex" + i, type: "USHORT", value: u.sequenceIndex })
                    .concat({
    ...
    (r.push({ name: "backtrackGlyphCount", type: "USHORT", value: e.backtrackCoverage.length }),
      e.backtrackCoverage.forEach(function (a, o) {
        r.push({ name: "backtrackCoverage" + o, type: "TABLE", value: new b.Coverage(a) });
      }),
      r.push({ name: "inputGlyphCount", type: "USHORT", value: e.inputCoverage.length }),
      e.inputCoverage.forEach(function (a, o) {
        r.push({ name: "inputCoverage" + o, type: "TABLE", value: new b.Coverage(a) });
      }),
      r.push({ name: "lookaheadGlyphCount", type: "USHORT", value: e.lookaheadCoverage.length }),
      e.lookaheadCoverage.forEach(function (a, o) {
        r.push({ name: "lookaheadCoverage" + o, type: "TABLE", value: new b.Coverage(a) });
      }),
      r.push({ name: "substitutionCount", type: "USHORT", value: e.lookupRecords.length }),
      e.lookupRecords.forEach(function (a, o) {
        r = r
          .concat({ name: "sequenceIndex" + o, type: "USHORT", value: a.sequenceIndex })
          .concat({ name: "lookupListIndex" + o, type: "USHORT", value: a.lookupListIndex });
      }));
...
function Jr(e) {
  ...
  for (var n = [], a = [], o = t.sizeOf() + Zt().sizeOf() * t.numTables; o % 4 !== 0;)
...
function Xa(e) {
  for (
    ...
    if (isNaN(x.advanceWidth))
      throw new Error("Glyph " + x.name + " (" + v + "): advanceWidth is not a number.");
  ...
  (M.uniqueID || (M.uniqueID = { en: e.getEnglishName("manufacturer") + ":" + J }),
  ...
  var W = [],
    ...
    w = e.metas && Object.keys(e.metas).length > 0 ? Kr.make(e.metas) : void 0,
    X = [B, A, F, O, q, P, H, V, T];
  (_ && X.push(_), e.tables.gsub && X.push(Qr.make(e.tables.gsub)), w && X.push(w));
  for (
    var et = Jr(X), fn = et.encode(), dn = Dt(fn), tt = et.fields, wt = !1, Pe = 0;
    Pe < tt.length;
    Pe += 1
  )
...
we.prototype = {
  ...
  getFeatureTable: function (e, t, r, n) {
    ...
    if (a) {
      for (
        var o, s = a.featureIndexes, u = this.font.tables[this.tableName].features, i = 0;
        i < s.length;
        i++
      )
      ...
      if (n) {
        var p = u.length;
        return (
          k.assert(p === 0 || r >= u[p - 1].tag, "Features must be added in alphabetical order."),
  ...
  getLookupTables: function (e, t, r, n, a) {
    ...
    if (o) {
      for (
        var u, i = o.lookupListIndexes, p = this.font.tables[this.tableName].lookups, l = 0;
        l < i.length;
        l++
      )
...
Q.prototype.getAlternates = function (e, t, r) {
  for (var n = [], a = this.getLookupTables(t, r, e, 3), o = 0; o < a.length; o++)
    for (var s = a[o].subtables, u = 0; u < s.length; u++)
      for (
        var i = s[u], p = this.expandCoverage(i.coverage), l = i.alternateSets, h = 0;
        h < p.length;
        h++
      )
...
Q.prototype.getLigatures = function (e, t, r) {
  for (var n = [], a = this.getLookupTables(t, r, e, 4), o = 0; o < a.length; o++)
    for (var s = a[o].subtables, u = 0; u < s.length; u++)
      for (
        var i = s[u], p = this.expandCoverage(i.coverage), l = i.ligatureSets, h = 0;
        h < p.length;
        h++
      )
...
Q.prototype.addSingle = function (e, t, r, n) {
  var a = this.getLookupTables(r, n, e, 1, !0)[0],
    o = At(a, 2, { substFormat: 2, coverage: { format: 1, glyphs: [] }, substitute: [] });
  k.assert(
    o.coverage.format === 1,
  ...
  (u < 0 && ((u = -1 - u), o.coverage.glyphs.splice(u, 0, s), o.substitute.splice(u, 0, 0)),
    (o.substitute[u] = t.by));
};
Q.prototype.addMultiple = function (e, t, r, n) {
  ...
  var a = this.getLookupTables(r, n, e, 2, !0)[0],
    o = At(a, 1, { substFormat: 1, coverage: { format: 1, glyphs: [] }, sequences: [] });
  k.assert(
    o.coverage.format === 1,
  ...
  var s = t.sub,
    u = this.binSearch(o.coverage.glyphs, s);
  (u < 0 && ((u = -1 - u), o.coverage.glyphs.splice(u, 0, s), o.sequences.splice(u, 0, 0)),
    (o.sequences[u] = t.by));
};
Q.prototype.addAlternate = function (e, t, r, n) {
  var a = this.getLookupTables(r, n, e, 3, !0)[0],
    o = At(a, 1, { substFormat: 1, coverage: { format: 1, glyphs: [] }, alternateSets: [] });
  k.assert(
    o.coverage.format === 1,
  ...
  var s = t.sub,
    u = this.binSearch(o.coverage.glyphs, s);
  (u < 0 && ((u = -1 - u), o.coverage.glyphs.splice(u, 0, s), o.alternateSets.splice(u, 0, 0)),
...
function tn(e) {
  ...
  for (var r = Qa(e), n = 0; n < r.length; ++n) {
    ...
    for (var p = 0; p < a.length; ++p)
      if (((o = s), (s = u), (u = a[(p + 1) % a.length]), s.onCurve)) t.lineTo(s.x, s.y);
      else {
        var l = u;
...
var Fe = Object.freeze(new pe(0, 0)),
  oo = { cvCutIn: 17 / 16, deltaBase: 9, deltaShift: 0.125, loop: 1, minDis: 1, autoFlip: !0 };
function ve(e, t) {
...
sn.prototype.exec = function (e, t) {
  ...
  if (!(this._errorState > 2)) {
    ...
    if (!n || n.ppem !== t) {
      ...
      var o = r.tables.cvt;
      if (o)
        for (var s = (n.cvt = new Array(o.length)), u = t / r.unitsPerEm, i = 0; i < o.length; i++)
          s[i] = o[i] * u;
      else n.cvt = [];
  ...
  if (((ve.prototype = t), !a))
    ...
    for (var p = 0; p < a.length; p++) {
      ...
      ((u = new ve("glyf", h.instructions)),
        exports.DEBUG && (console.log("---EXEC COMP " + p + "---"), (u.step = -1)),
        xt(h, u, r, n));
      for (
        var c = Math.round(l.dx * r), f = Math.round(l.dy * n), v = u.gZone, x = u.contours, m = 0;
        m < v.length;
        m++
      ) {
        var y = v[m];
...
xt = function (e, t, r, n) {
  for (
    ...
    ((i = a[p]), (s[p] = new pe(i.x * r, i.y * n, i.lastPointOfContour, i.onCurve)));
  for (var l, h, c = 0; c < o; c++)
    ((i = s[c]),
      l || ((l = i), u.push(c)),
      i.lastPointOfContour
        ? ((i.nextPointOnContour = l), (l.prevPointOnContour = i), (l = void 0))
        : ((h = s[c + 1]), (i.nextPointOnContour = h), (h.prevPointOnContour = i)));
  if (!t.inhibitGridFit) {
    if (exports.DEBUG) {
...
function Ro(e) {
  ...
  for (var s = 0; s < n; s++)
    (Se(e),
      exports.DEBUG && console.log(++e.step, s + 1 < n ? "next loopcall" : "done loopcall", s));
  ((e.ip = a), (e.prog = o));
}
function Fo(e) {
  var t = e.stack.pop();
  ...
  for (
    ...
    (o.setRelative(l, l, h, s),
      ...
      exports.DEBUG &&
        console.log(
          t.step,
          (t.loop > 1 ? "loop " + (t.loop - u) + ": " : "") + "SHP[" + (e ? "rp1" : "rp2") + "]",
          p,
        ));
  }
  t.loop = 1;
...
function Mo(e) {
  for (var t = e.stack, r = e.loop, n = e.fv, a = t.pop() / 64, o = e.z2; r--;) {
    var s = t.pop(),
      u = o[s];
    (exports.DEBUG &&
      console.log(e.step, (e.loop > 1 ? "loop " + (e.loop - r) + ": " : "") + "SHPIX[]", s, a),
      n.setRelative(u, u, a),
      n.touch(u));
  }
  e.loop = 1;
...
function Po(e) {
  for (var t = e.stack, r = e.rp0, n = e.z0[r], a = e.loop, o = e.fv, s = e.pv, u = e.z1; a--;) {
    var i = t.pop(),
      p = u[i];
    (exports.DEBUG &&
      console.log(e.step, (e.loop > 1 ? "loop " + (e.loop - a) + ": " : "") + "ALIGNRP[]", i),
...
function hr(e, t) {
  ...
  (exports.DEBUG && console.log(t.step, "GC[" + e + "]", n),
    r.push(t.dpv.distance(a, Fe, e, !1) * 64));
}
function fr(e, t) {
  var r = t.stack,
    n = r.pop(),
...
function Is(e, t) {
  ...
  if (h)
    for (var f = 0; f < t.lookupRecords.length; f++)
      for (
        var v = t.lookupRecords[f], x = v.lookupListIndex, m = this.getLookupByIndex(x), y = 0;
...
K.prototype.lookupFeature = function (e) {
  ...
  for (var a = this.getFeatureLookups(n), o = [].concat(t.context), s = 0; s < a.length; s++)
    for (var u = a[s], i = this.getLookupSubtables(u), p = 0; p < i.length; p++) {
      var l = i[p],
      ...
      switch (h) {
        case "11":
          ((f = c(t.current)),
            f && o.splice(r, 1, new be({ id: 11, tag: e.tag, substitution: f })));
          break;
        case "12":
          ((f = c(t.current)),
            f && o.splice(r, 1, new be({ id: 12, tag: e.tag, substitution: f })));
          break;
        case "63":
          ((f = c(t)),
            Array.isArray(f) &&
        ...
        case "21":
          ((f = c(t.current)),
            f && o.splice(r, 1, new be({ id: 21, tag: e.tag, substitution: f })));
          break;
      }
...
function R(e) {
  ((e = e || {}),
    (e.tables = e.tables || {}),
    e.empty ||
      (De(e.familyName, "When creating a new Font object, familyName is required."),
      De(e.styleName, "When creating a new Font object, styleName is required."),
      De(e.unitsPerEm, "When creating a new Font object, unitsPerEm is required."),
...
R.prototype.stringToGlyphs = function (e, t) {
  ...
  for (
    var s = n.getTextGlyphs(e), u = s.length, i = new Array(u), p = this.glyphs.get(0), l = 0;
    l < u;
    l += 1
  )
...
var fi = { make: ci, parse: hi },
  ...
  vi = function () {
    var e = this.parseUShort();
    if (
      (k.argument(e === 1 || e === 2 || e === 3, "Unsupported CaretValue table version."), e === 1)
    )
...
function Oi(e, t, r, n) {
  for (
    var a = new C.Parser(e, t), o = n ? a.parseUShort : a.parseULong, s = [], u = 0;
    u < r + 1;
    u += 1
  ) {
    var i = o.call(a);
...
function wi(e, t) {
  for (var r = [], n = 44, a = 0; a < t; a += 1) {
    var o = C.getTag(e, n),
      ...
      p = void 0;
    (u < i ? (p = "WOFF") : (p = !1),
      r.push({ tag: o, offset: s, compression: p, compressedLength: u, length: i }),
      (n += 20));
  }
  return r;
}
...
function Ft(e, t) {
  ...
  for (var l, h, c, f, v, x, m, y, U, S, B, A, F = 0; F < s; F += 1) {
    ...
    switch (O.tag) {
      ...
      case "maxp":
        ((T = I(o, O)),
          (a.tables.maxp = qr.parse(T.data, T.offset)),
