-- Upsert pricing plans with correct display data using their UUIDs
...
(
  ...
  '["500 AI credits/mo", "3 free courses", "Basic AI tutor", "500 AI credits/month", "Community access", "Progress tracking"]'::jsonb,
  'Get started free',
  '/signup',
  false,
  10,
