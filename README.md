...
- **Custom Video Player**: Built-in React-based player overlay on YouTube streams with a natively integrated Subscribe button, progress tracking, volume, CC, and timeline controls. Auto-play issues gracefully handled to prevent browser abort errors.
