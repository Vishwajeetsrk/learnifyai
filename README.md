...
- ✅ **Premium Branded Covers for All 12 Courses**: New 800×450 covers generated by `scripts/gen-course-covers.cjs` into `public/course-covers/<slug>.svg` — per-course accent gradients, glyph ring, title + tagline, FREE · level · lesson-count badges, Learnify AI mark. Migration `20270810000003_course_covers.sql` points every course at its new cover (using the existing cover-image feature, now with consistent premium branding).
