...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-T0BJmBop.mjs");
...
const manifest = {
  "0cc2f971d05de3145f43353722b8178a645ace556cc25413698d1b3f614b3af3": {
    functionName: "markCourseStarted_createServerFn_handler",
    importer: () => import("./course.functions-T6JRcBtD.mjs")
  },
  "0d0c07a65c0857a08946e2697199515335f20099bc56aa4650be6a1beb0700ce": {
    functionName: "adminSetPassword_createServerFn_handler",
    importer: () => import("./admin-users.functions-CesvKpiU.mjs")
  },
  "0fe497f84feaa9c26289e06c5d010fd10007bd792c5b4f317356ad7ef5df9201": {
    functionName: "generateFullCourse_createServerFn_handler",
    importer: () => import("./course-builder.functions-DQ61BdBe.mjs")
  },
  "16419254d84a19e25f489cee6157c632467f7e6774668931578e88439b949377": {
    functionName: "adminSetUserRoles_createServerFn_handler",
    importer: () => import("./admin-users.functions-CesvKpiU.mjs")
  },
  "2c8daa5f1ea93e574a34c03dce003349931bbef772e387a1cafe14f69bdf379b": {
    functionName: "sendWelcomeEmail_createServerFn_handler",
    importer: () => import("./welcome-email.functions-DHK7kZGM.mjs")
  },
  "31cd0087befaea9f28691dcd70f4a21113aea1822989cc6cf42e905d3993bf14": {
    functionName: "adminDeleteUser_createServerFn_handler",
    importer: () => import("./admin-users.functions-CesvKpiU.mjs")
  },
  "32ec0226b9128c668db59a78babcb2a98cdb0b8255ee9827fa188387332d3644": {
    functionName: "verifyYoutubeKey_createServerFn_handler",
    importer: () => import("./youtube.functions-Yg5ojd_r.mjs")
  },
  "33af551c8f8394d9f57af892e3af12cb6f428728b849520f0b91d27807f95f0e": {
    functionName: "runAiTool_createServerFn_handler",
    importer: () => import("./ai-tools.functions-BDo9Au_2.mjs")
  },
  "38660a908ea62c5e5e1ea56cc139ed8843b00f8bfacf37baf697ab9dfdbb38fd": {
    functionName: "enrollFree_createServerFn_handler",
    importer: () => import("./course.functions-T6JRcBtD.mjs")
  },
  "3c02686d94d9737600d5b12d69cb30c7db2128447be23835394818cbbd1c30fa": {
    functionName: "adminSetAiCredits_createServerFn_handler",
    importer: () => import("./admin-users.functions-CesvKpiU.mjs")
  },
  "487fc7f6282ce4b544a9e6bbd96bcce70e405455d873c1697dd8e5d1283872d9": {
    functionName: "adminSetDisabled_createServerFn_handler",
    importer: () => import("./admin-users.functions-CesvKpiU.mjs")
  },
  "4a4ba4e480cefba40d5cab46088e1cac2cf971cbf632e1bcd416c7e075b78ba4": {
    functionName: "listAllEnrichmentRuns_createServerFn_handler",
    importer: () => import("./youtube.functions-Yg5ojd_r.mjs")
  },
  "4bf0d871c1b1448bf83ecae994053dfefc9592abecd0f940b98c0f46242944f0": {
    functionName: "getPublicProfile_createServerFn_handler",
    importer: () => import("./profile.functions-DRzSEoHh.mjs")
  },
  "504e67b3aad4cab0e2cfb54e1fcade68aadaf5924df935bd335cf29d093733bd": {
    functionName: "retryPendingCertificateEmails_createServerFn_handler",
    importer: () => import("./cert.functions-COio8uDD.mjs")
  },
  "52e8b3a8374cfc4c7f341db1275eccec848f905cddd81b72ce7910e92d6ebb98": {
    functionName: "generateCourseThumbnail_createServerFn_handler",
    importer: () => import("./thumbnail.functions-CePQtvGX.mjs")
  },
  "53f06c97cbe7e94e3c1ce694ee7711927e617b2e4f4daa837d1aed57029f5e43": {
    functionName: "materializeCourse_createServerFn_handler",
    importer: () => import("./course-builder.functions-DQ61BdBe.mjs")
  },
  "601c59f1d3b91e129f466dadc80c22dad8300800318af8ea507e69648fe75805": {
    functionName: "adminEmailCertificate_createServerFn_handler",
    importer: () => import("./cert.functions-COio8uDD.mjs")
  },
  "650b04cc0e21de1a2a2c7a4767bb223985953e97b50d84eeb1221e8983ab99f1": {
    functionName: "getPlatformStats_createServerFn_handler",
    importer: () => import("./stats.functions-GEN_Ohqa.mjs")
  },
  "75a41eaad6e8e420ff959bd09f5f09676e4cb6e6827615b69002573eecffdcbe": {
    functionName: "adminListUsers_createServerFn_handler",
    importer: () => import("./admin-users.functions-CesvKpiU.mjs")
  },
  "7b5e03bcc1a55c5b8bb598a5c6532a41d70167cde51cd5e8e78b48542eed3214": {
    functionName: "getDemandForecast_createServerFn_handler",
    importer: () => import("./forecast.functions-DROddEOq.mjs")
  },
  "7cdf308c08cefa76b5aff91881d47d0a7c38e57c538ac8578cbcc0b0323f57c2": {
    functionName: "adminCreateUser_createServerFn_handler",
    importer: () => import("./admin-users.functions-CesvKpiU.mjs")
  },
  "7d6a1b7ca248c0cff671e1203e94e4fa6ad30148eb1e00a15952d0f47c461126": {
    functionName: "regenerateCourseFromYouTube_createServerFn_handler",
    importer: () => import("./youtube.functions-Yg5ojd_r.mjs")
  },
  "7e44cff770ce63c7f54ff4f42a5f1198b6c13b6bb706edd2e84253ce3272ea47": {
    functionName: "adminUpdateUser_createServerFn_handler",
    importer: () => import("./admin-users.functions-CesvKpiU.mjs")
  },
  "a7c24171bf57ffee1da0697bb684003a49aeebe73f78cd1b93f8840650b57cbb": {
    functionName: "getRecommendedCourses_createServerFn_handler",
    importer: () => import("./recommendations.functions-tB3R5IpR.mjs")
  },
  "afdf7f4e89351c40abdc7faeec59a2afe24db5dbdf17bc8d2ca638aa04e73aae": {
    functionName: "emailCertificate_createServerFn_handler",
    importer: () => import("./cert.functions-COio8uDD.mjs")
  },
  "b2c2671ec0dd0443e3dd92fb41a7adab672c40eb8e471dcf5a2b8f70ad13090c": {
    functionName: "bootstrapSuperAdmin_createServerFn_handler",
    importer: () => import("./admin-users.functions-CesvKpiU.mjs")
  },
  "b522cde227308a9e042aa0dc147f5ef57ab07c8dd0d53ccbb56a686df9863038": {
    functionName: "listCourseEnrichmentRuns_createServerFn_handler",
    importer: () => import("./youtube.functions-Yg5ojd_r.mjs")
  },
  "bc9f1bbb4d7a46ef2c51ed471408f0417d9d858da2193d33c0ff9f36cfe7653e": {
    functionName: "lessonAiHelper_createServerFn_handler",
    importer: () => import("./lesson-ai.functions-CJPXZc-a.mjs")
  },
  "cfadcb0866ebd11d60c0cbe50fdbdd66a2c9c01a93f53dd16537edcbce7e43d5": {
    functionName: "startCourseEnrichment_createServerFn_handler",
    importer: () => import("./youtube.functions-Yg5ojd_r.mjs")
  },
  "e97ccf3588dd1866bb25f9a7b8f8279c126f7c27de88a0113e7ef54960811555": {
    functionName: "recomputeProgress_createServerFn_handler",
    importer: () => import("./course.functions-T6JRcBtD.mjs")
  },
  "f8700f9e1b3b1cba227af402b2df3b2e160cb4c5202990d7b89fb6f97b418ac6": {
    functionName: "getCreatorAnalytics_createServerFn_handler",
    importer: () => import("./profile.functions-DRzSEoHh.mjs")
  },
  "f94c89c281f45fa617f0f11172b851f88434619b7f363ccd01a3e03cd9236f76": {
    functionName: "getEnrichmentRun_createServerFn_handler",
    importer: () => import("./youtube.functions-Yg5ojd_r.mjs")
  },
  "f966471f0f8d772914e7079bb4c6bdb7b3bdc0b3bbf083e774838addc510cd74": {
    functionName: "checkoutCart_createServerFn_handler",
    importer: () => import("./course.functions-T6JRcBtD.mjs")
  },
  "fd120808553ec5488e5806f56b6cb30ddc43813e37d2d7cd37a430973322651d": {
    functionName: "cancelEnrichmentRun_createServerFn_handler",
    importer: () => import("./youtube.functions-Yg5ojd_r.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BGh9Ntsg.mjs").then((n) => n.r),
    import("./start-DX-t9ar-.mjs"),
