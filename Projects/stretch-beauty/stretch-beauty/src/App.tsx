...
const PAGES = [
  ...
  { path: 'shop/face', title: 'Shop Face', description: 'Serums, cleansers, and daily radiance essentials.' },
  { path: 'shop/beauty-tools', title: 'Shop Beauty Tools', description: 'Brushes, rollers, and ritual accessories.' },
  { path: 'shop/body', title: 'Shop Body', description: 'Hydrating body care with sustainable formulas.' },
  { path: 'about', title: 'About Us', description: 'Ethical beauty with a lighter footprint on the planet.' },
  { path: 'journal', title: 'Journal', description: 'Stories on sustainable skincare and mindful rituals.' },
