...
export const NAV_ITEMS = [
  { label: "Device", section: "device" as const },
  { label: "Real Stories", section: "real-stories" as const },
  { label: "Science", section: "science" as const },
  { label: "Plans", section: "plans" as const },
  { label: "Reach Us", section: "contact" as const },
] as const;
