...
import VelorixLogo from './VelorixLogo';
...
type VelorixNavbarProps = {
  fixed?: boolean;
};

export default function VelorixNavbar({ fixed = false }: VelorixNavbarProps) {
    ...
    <>
      ...
      >
        <a
          ...
          style={{ fontFamily: 'Inter, sans-serif' }}
        >
          <VelorixLogo size={28} className="text-white" />
          velorix
        </a>
        <div
