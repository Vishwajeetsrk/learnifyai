...
export default function HomePage() {
  return (
    <SiteLayout>
      ...
      <LogoRow />
      <PageSections />
      <section id="pricing" className="scroll-mt-24 border-t border-white/5 px-4 py-20 sm:px-8 md:px-12 md:py-28">
      ...
      <section id="contact" className="scroll-mt-24 border-t border-white/5 px-4 py-20 sm:px-8 md:px-12 md:py-28">
