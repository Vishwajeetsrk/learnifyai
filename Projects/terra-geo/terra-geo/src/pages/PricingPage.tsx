...
const PLANS = [
  ...
  { name: 'Enterprise', price: 'Custom', detail: 'Dedicated tiles, VPC deploy, solutions architects' },
] as const;

export default function PricingPage({ embedded }: { embedded?: boolean }) {
  const content = (
    <section id="pricing" className="scroll-mt-24 border-t border-border px-4 py-20 sm:px-8 md:py-28">
