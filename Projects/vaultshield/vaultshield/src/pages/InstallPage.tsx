...
export function InstallPage() {
  const platforms = [
    ...
    { name: 'Browser extensions', detail: 'Chrome, Firefox, Safari, and Edge with passkey support.' },
  ];
    ...
    <main className="relative z-10 mx-auto max-w-[1280px] px-5 py-16 sm:px-8">
      <section id="install" className="scroll-mt-24">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {platforms.map((p) => (
            <article key={p.name} className="rounded-2xl border border-[#192837]/10 bg-white/60 p-6 backdrop-blur-sm">
