  ...
  return (
    <main className="px-4 pb-24 pt-12 md:px-8 md:pt-16">
      <div className="mx-auto max-w-[1400px]">
        ...
        >
          Foundation Epoch partners with product teams who refuse to trade craft for speed. We combine
          cinematic hero experiences with composable infrastructure—so your launch feels inevitable
          and your stack stays trustworthy.
        </motion.p>
