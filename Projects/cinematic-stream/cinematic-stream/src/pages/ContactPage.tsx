  ...
  return (
    ...
    >
      <div className="liquid-glass max-w-xl rounded-2xl p-6 md:p-8">
        ...
        <a href="mailto:studios@framecast.example" className="mt-2 block text-lg font-medium text-white hover:text-gray-200">
          studios@framecast.example
        </a>
        <p className="mt-6 text-sm text-gray-400">Member support</p>
        <a href="mailto:support@framecast.example" className="mt-2 block text-lg font-medium text-white hover:text-gray-200">
