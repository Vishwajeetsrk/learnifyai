...
const SECTIONS = [
  { id: 'movies', title: 'Movies', body: 'Premieres, festival cuts, and exclusive director editions streaming in 4K HDR.' },
  { id: 'tv-series', title: 'TV Series', body: 'Serialized originals with weekly drops and curated binge collections.' },
  { id: 'editors-pick', title: "Editor's Pick", body: 'Hand-selected features updated every Friday by the Framecast editorial team.' },
  { id: 'interviews', title: 'Interviews', body: 'Long-form conversations with directors, composers, and cinematographers.' },
  { id: 'user-reviews', title: 'User Reviews', body: 'Community ratings and scene-level notes from verified members.' },
] as const;
...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-black text-white">
      ...
      {SECTIONS.map((s) => (
        <section key={s.id} id={s.id} className="scroll-mt-24 border-t border-white/10 px-4 py-20 sm:px-6 md:px-12 md:py-28">
      ...
      <section id="contact" className="scroll-mt-24 border-t border-white/10 px-4 py-20 sm:px-6 md:px-12">
