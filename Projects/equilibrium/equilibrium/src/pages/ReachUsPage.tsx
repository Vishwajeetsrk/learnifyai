  ...
  const form = (
    <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
      ...
      <p className="text-center text-sm text-muted">
        Or email{' '}
        <a href="mailto:hello@aethera.studio" className="text-foreground underline-offset-2 hover:underline">
    ...
    return (
      <section className="border-t border-black/8 bg-background px-6 py-24 md:px-8">
        <div className="mx-auto max-w-xl">
          ...
          <h2 className="font-display mt-3 text-4xl font-normal tracking-[-1.5px]">Start a journey</h2>
