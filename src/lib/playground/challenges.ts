...
export const DEFAULT_CHALLENGES = [
  {
    ...
    hints: ["Try using a Hash Map for O(N) time complexity.", "Store seen numbers as key and index as value."],
  ...
  },
  {
    ...
    hints: ["Use Regex `/[^a-z0-9]/g` to clean string.", "Compare clean string with its reversed version."],
  ...
  },
  {
    ...
    hints: ["Use three pointers: prev, curr, and next.", "Iterate through the nodes while reassigning pointers."],
    initial_code: "function reverseList(head) {\n  let prev = null;\n  let curr = head;\n  // Complete implementation\n  return prev;\n}",
  },
  {
    id: "c-104",
    ...
    hints: ["Use a sliding window technique with a Set or Map.", "Maintain `left` and `right` window bounds."],
    initial_code: "function lengthOfLongestSubstring(s) {\n  // Write your sliding window solution\n  \n}",
  },
  {
    id: "c-105",
    ...
    initial_code: "function levelOrder(root) {\n  if (!root) return [];\n  // Complete BFS queue logic\n}",
  },
  {
    id: "c-106",
  ...
  },
  {
    ...
    language: "python",
    points: 40,
    description: "Write a function that takes a list of integers and returns only the squared values of even numbers using Python list comprehensions.",
  ...
  },
  {
    ...
    language: "python",
    points: 80,
    description: "Build a custom Python decorator `@timeit` that measures and prints execution time.",
  ...
  },
  {
    ...
    language: "sql",
    points: 85,
    description: "Write an SQL query to calculate Monthly Active Users (MAU) and month-over-month retention.",
  ...
  },
  {
    ...
    hints: ["Base62 encoding (`a-z, A-Z, 0-9`) maps 64-bit ID to 7 characters.", "Use Redis for hot URL cache with LRU eviction."],
    initial_code: "// System Design Spec & Architecture Document\n// 1. API Endpoints\n// 2. Database Schema (NoSQL vs Relational)\n// 3. Cache Strategy",
  },
  {
    id: "c-112",
    ...
    hints: ["Track timestamps in a Sorted Set (Redis ZSET).", "Remove items older than current_time - 60s."],
    initial_code: "class RateLimiter {\n  constructor(limit = 100, windowMs = 60000) {\n    this.limit = limit;\n    this.windowMs = windowMs;\n  }\n  isAllowed(userId) {\n    // Implement sliding window counter\n  }\n}",
  }
];
