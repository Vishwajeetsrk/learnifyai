  ...
  .handler(async ({ context }) => {
    ...
    const PREMIUM_TEMPLATES = [
      ...
      },
      {
        ...
        category: "Web & Tech",
        bg_image_url: "/templates/premium/w3schools-cert.svg",
        thumbnail_url: "/templates/premium/w3schools-cert.svg",
        theme_colors: {
          primary: "#04aa6d",
          accent: "#282a35",
          background: "#ffffff",
        ...
        fields_json: {
          ...
          title: {
            ...SVG_DEFAULT_FIELDS.title,
            text: "W3SCHOOLS CERTIFIED DEVELOPER",
            fontFamily: "Space Grotesk, sans-serif",
            fontWeight: "bold",
            fontSize: 28,
            color: "#04aa6d",
          ...
          subtitle: {
            ...SVG_DEFAULT_FIELDS.subtitle,
            text: "INTERNATIONAL WEB DEVELOPMENT CERTIFICATION",
            fontFamily: "Inter, sans-serif",
            fontSize: 9,
            color: "#555555",
            x: 50,
      ...
      },
      {
        ...
        bg_image_url: "/templates/premium/great-learning-cert.svg",
        thumbnail_url: "/templates/premium/great-learning-cert.svg",
        theme_colors: {
          primary: "#003b73",
          accent: "#d4af37",
          background: "#001f3f",
        ...
        fields_json: {
          ...
          title: {
            ...SVG_DEFAULT_FIELDS.title,
            text: "GREAT LEARNING EXECUTIVE ACADEMY",
            fontFamily: "Cinzel, serif",
            fontWeight: "bold",
            fontSize: 26,
            color: "#d4af37",
          ...
          subtitle: {
            ...SVG_DEFAULT_FIELDS.subtitle,
            text: "POST GRADUATE EXECUTIVE DIPLOMA",
            fontFamily: "Inter, sans-serif",
            fontSize: 9,
            color: "#94a3b8",
            x: 50,
