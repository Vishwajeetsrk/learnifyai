...
<p>By subscribing to Pro (₹199/mo), Career Pro (₹499/mo), or Enterprise (Custom) plans, you authorize Learnify AI and Cashfree to auto-debit the recurring fee on a monthly cycle. Subscriptions remain active until cancelled via the Billing Dashboard.</p>

<h2>3. Grace Period & Overdue Payments</h2>
<p>Failed payment renewals are subject to a 3-day grace period. Access will be downgraded to the Free plan if the payment mandate cannot be successfully resolved after the grace period.</p>

<h2>4. AI Credit Allocations</h2>
<p>AI credits are granted monthly based on the active plan: 500 for Free, 10,000 for Pro, 25,000 for Career Pro, and custom for Enterprise. Credits are non-transferable and reset at the end of each billing cycle.</p>
