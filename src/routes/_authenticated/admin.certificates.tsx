            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between bg-card border rounded-lg p-2 shadow-sm">
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" size="sm" onClick={addOrgLogo}>
                    <Building2 className="h-4 w-4" /> Org Logo
                  </Button>
                </div>
              ...
              <div className="bg-muted p-8 rounded-xl border flex items-center justify-center overflow-auto shadow-inner h-[700px]">
                <div
                  ...
                  style={{
                    ...
                    height: 595,
                    ...getPatternStyle(
                      active.config_json.design.background_pattern,
                      active.config_json.design.bg_color,
                      active.config_json.design.accent_color,
                    ),
                    ...(active.bg_image_url
                      ? { backgroundImage: `url(${active.bg_image_url})`, backgroundSize: "cover" }
                      : {}),
                    border:
                ...
                >
                  {active.config_json.design.border_style === "ornate" && (
                    <div
                      className="absolute inset-2 pointer-events-none z-0"
                      style={{ border: `1px solid ${active.config_json.design.accent_color}88` }}
                    />
                  )}
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: "100%",
                          alignItems:
                            el.type === "image" || el.type === "org_logo" ? "center" : undefined,
                        }}
                      >
            ...
            <div className="bg-card border rounded-xl p-5 shadow-card space-y-6 h-fit sticky top-6 max-h-[calc(100vh-120px)] overflow-y-auto">
              ...
              <div>
                <h3 className="font-semibold flex items-center gap-2 mb-4">
                  <Settings className="h-4 w-4 text-primary" /> Template Settings
                </h3>
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <Input
                      value={active.bg_image_url || ""}
                      onChange={(e) => setActive({ ...active, bg_image_url: e.target.value })}
                      placeholder="https://..."
                    />
                  </div>
                </div>
              ...
              <div className="border-t pt-5">
                <h4 className="font-semibold flex items-center gap-2 mb-3 text-sm">
                  <Palette className="h-3.5 w-3.5 text-primary" /> Theme Presets
                </h4>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div>
                    ...
                    <div className="relative mt-1">
                      <input
                        type="color"
                        value={active.config_json.design.accent_color}
                      ...
                      <div
                        ...
                        style={{
                          background: active.config_json.design.accent_color + "22",
                          borderColor: active.config_json.design.accent_color,
                        }}
                      >
                        <div
                          className="h-5 w-5 rounded border"
                          style={{ background: active.config_json.design.accent_color }}
                        />
                  ...
                  <div>
                    ...
                    <div className="relative mt-1">
                      <input
                        type="color"
                        value={active.config_json.design.bg_color}
                      ...
                      <div
                        className="w-full h-9 rounded-lg border flex items-center gap-2 px-2"
                        style={{
                          background: active.config_json.design.bg_color,
                          borderColor: active.config_json.design.bg_color,
                        }}
                      >
                        <div
                          className="h-5 w-5 rounded border"
                  ...
                  <div>
                    ...
                    <div className="relative mt-1">
                      <input
                        type="color"
                        value={active.config_json.design.text_color}
                      ...
                      <div
                        className="w-full h-9 rounded-lg border flex items-center gap-2 px-2"
                        style={{
                          background: active.config_json.design.text_color + "15",
                          borderColor: active.config_json.design.text_color + "44",
                        }}
                      >
                        <div
                          className="h-5 w-5 rounded border"
                          style={{ background: active.config_json.design.text_color }}
                        />
                        <span className="text-xs font-mono">
                          {active.config_json.design.text_color}
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="border-t pt-5">
                <h4 className="font-semibold flex items-center gap-2 mb-3 text-sm">
                  <Square className="h-3.5 w-3.5 text-primary" /> Border Style
                </h4>
                <div className="grid grid-cols-5 gap-1.5">
                  {BORDER_OPTIONS.map((b) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className="h-7 w-full rounded flex items-center justify-center text-lg font-semibold"
                          style={{
                            color: active.config_json.design.accent_color,
                            borderBottom:
                              b.id === "none"
                                ? "none"
                                : `3px ${b.id} ${active.config_json.design.accent_color}`,
                          }}
                        >
                ...
                {active.config_json.design.border_style !== "none" && (
                  <div className="mt-2">
                    <Label className="text-xs">
                      Border Width: {active.config_json.design.border_width}px
                    </Label>
                    <input
                      type="range"
                      min="2"
              ...
              <div className="border-t pt-5">
                <h4 className="font-semibold flex items-center gap-2 mb-3 text-sm">
                  <Scissors className="h-3.5 w-3.5 text-primary" /> Corner Style
                </h4>
                    ...
                    return (
                      ...
                      >
                        <svg
                          viewBox="0 0 40 40"
                          className="h-6 w-6"
                          style={{ color: active.config_json.design.accent_color }}
                        >
                          {c.id === "diagonal" ? (
                            <>
              ...
              <div className="border-t pt-5">
                <h4 className="font-semibold flex items-center gap-2 mb-3 text-sm">
                  <LayoutGrid className="h-3.5 w-3.5 text-primary" /> Background Pattern
                </h4>
                <div className="grid grid-cols-5 gap-1.5">
              ...
              <div className="border-t pt-5">
                <h4 className="font-semibold flex items-center gap-2 mb-3 text-sm">
                  <LayoutGrid className="h-3.5 w-3.5 text-primary" /> Layout
                </h4>
                <div className="grid grid-cols-2 gap-2">
              ...
              <div className="border-t pt-5">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <Select
                      value={active.config_json.design.font_family}
                      onValueChange={(v) => updateDesign({ font_family: v })}
                    >
                            ...
                            <button
                              onClick={() => {
                                ...
                                if (i > 0) {
                                  ...
                                  setActive({
                                    ...active,
                                    config_json: { ...active.config_json, elements: copy },
                                  });
                                }
                              }}
                        ...
                        <div className="flex gap-1">
                          <Button
                            ...
                            onClick={() => {
                              ...
                              setActive({
                                ...active,
                                config_json: { ...active.config_json, elements: newEls },
                              });
                          ...
                          <Button
                            ...
                            onClick={() => {
                              setActive({
                                ...
                                config_json: {
                                  ...active.config_json,
                                  elements: active.config_json.elements.filter(
                                    (e) => e.id !== selectedEl,
                                  ),
                                },
                              });
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-center gap-1 flex-wrap p-2 bg-muted/40 rounded-lg border">
                            <button
                              ...
                              className={`p-1.5 rounded transition-colors ${el.fontWeight === "bold" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:bg-accent"}`}
                            >
                            ...
                            <button
                              ...
                              className={`p-1.5 rounded transition-colors ${el.fontStyle === "italic" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:bg-accent"}`}
                            >
                            ...
                            <button
                              ...
                              className={`p-1.5 rounded transition-colors ${el.textDecoration === "underline" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:bg-accent"}`}
                            >
                            ...
                            <Select
                              onValueChange={(v: string) => {
                                const sizes: Record<string, any> = {
                                  ...
                                  h4: { fontSize: 22, fontWeight: "bold" },
                                  body: { fontSize: 18, fontWeight: "normal" },
                                  small: { fontSize: 13, fontWeight: "normal" },
                                };
                                updateActiveEl(sizes[v] || {});
                              }}
                            >
                              <SelectTrigger className="h-7 w-[80px] text-[10px] gap-0">
                            ...
                            <Popover>
                              <PopoverTrigger asChild>
                                <button className="p-1.5 rounded text-muted-foreground hover:bg-accent transition-colors">
                                ...
                                <div className="grid grid-cols-8 gap-0.5 max-h-40 overflow-y-auto">
                                  {[
                                    ...
                                    <button
                                      ...
                                      type="button"
                                      onClick={() =>
                                        updateActiveEl({ content: (el.content || "") + e })
                                      }
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            <div>
                              ...
                              <Input
                                ...
                                value={el.fontSize}
                                onChange={(e) =>
                                  updateActiveEl({ fontSize: Number(e.target.value) })
                                }
                                className="mt-1"
                              />
                            </div>
                          ...
                          <div className="grid grid-cols-10 gap-1">
                            {[
                              ...
                              <button
                                key={c}
                                onClick={() => updateActiveEl({ color: c })}
                          ...
                          <div>
                            ...
                            <Select
                              value={el.fontFamily}
                              onValueChange={(v) => updateActiveEl({ fontFamily: v })}
                            >
                              <SelectTrigger className="mt-1">
                                <SelectValue />
                              </SelectTrigger>
                          ...
                          <div>
                            ...
                            <Select
                              value={el.align}
                              onValueChange={(v) => updateActiveEl({ align: v as any })}
                            >
                              <SelectTrigger className="mt-1">
                                <SelectValue />
                              </SelectTrigger>
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            <div>
                              ...
                              <Input
                                type="number"
                                value={el.width}
                                onChange={(e) => updateActiveEl({ width: Number(e.target.value) })}
                                className="mt-1"
                              />
                            </div>
                            <div>
                              ...
                              <Input
                                type="number"
                                value={el.height}
                                onChange={(e) => updateActiveEl({ height: Number(e.target.value) })}
                                className="mt-1"
                              />
                            </div>
                          </div>
                      ...
                      {el.type === "org_logo" && (
                        <div className="space-y-3">
                          <div className="text-sm text-muted-foreground">
                            Displays your organization's logo from{" "}
                            <strong>Settings → Branding</strong> when rendered on a certificate.
