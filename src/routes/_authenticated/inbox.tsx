    ...
    <div className="px-4 sm:px-6 lg:px-10 py-6 sm:py-10 max-w-4xl">
      ...
      <Tabs defaultValue="notifs" className="mt-6">
        <TabsList className="w-full sm:w-auto">
          ...
          >
            <Bell className="h-3 w-3.5 sm:h-3.5" />{" "}
          ...
          <TabsTrigger
            ...
            className="flex-1 sm:flex-initial text-xs sm:text-sm px-2 sm:px-4"
          >
            <CalendarClock className="h-3 w-3.5 sm:h-3.5" />{" "}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-1.5">
                      ...
                      {!n.read && (
                        <Badge
                          variant="secondary"
                          className="text-[9px] sm:text-[10px] shrink-0 h-5"
                        >
                          New
                        </Badge>
                      )}
          ...
          {reminders.isLoading ? (
            ...
            (reminders.data ?? []).map((r) => (
              ...
              >
                ...
                <div
                  className="flex flex-row sm:flex-col gap-1"
                  onClick={(e) => e.stopPropagation()}
                >
                  <Button
                    size="icon"
