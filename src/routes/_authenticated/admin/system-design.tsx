...
export const Route = createFileRoute("/_authenticated/admin/system-design")({
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-6 sm:py-8 space-y-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                {topics.length} topics · Manage curriculum
              </p>
            </div>
          </div>
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-xs text-muted-foreground mt-0.5">
                          {topic.subtitle || topic.description?.slice(0, 80)}
                        </p>
                        <p className="text-[10px] text-muted-foreground mt-0.5">
                          ID: {topic.topic_id} · Sections: {topic.sections?.length || 0} · Quiz:{" "}
                          {topic.quiz?.length || 0} Q
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-1 shrink-0">
                      <Button
                        ...
                        onClick={() => toggleEnabled(topic.id, topic.enabled)}
                      >
                        {topic.enabled ? (
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <DialogContent className="sm:max-w-lg">
            <DialogHeader>
              <DialogTitle>
                <MonitorPlay className="h-4 w-4 inline mr-1" />{" "}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1.5 col-span-2">
                  ...
                  <Input
                    ...
                    placeholder="Video Streaming Architecture"
                  />
                </div>
                <div className="space-y-1.5 col-span-2">
                  ...
                  <Textarea
                    ...
                    rows={3}
                    placeholder="Describe what this system design topic covers..."
                  />
                </div>
                <div className="space-y-1.5">
