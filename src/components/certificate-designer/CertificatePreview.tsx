      ...
      {elements.map((el, i) => {
        ...
        return (
          <div
            ...
            onClick={(e) => { e.stopPropagation(); if (!isLocked) onSelect(el.id); }}
          >
            <div
            ...
            >
              ...
              {el.type === "svg" && el.svgContent && (
                <div className="w-full h-full flex items-center justify-center pointer-events-none"
                  dangerouslySetInnerHTML={{ __html: el.svgContent.replace(/currentColor/, el.svgColor || design.accent_color) }} />
              )}
              ...
              {el.type === "seal_icon" && (
                <div className="w-full h-full rounded-full border-4 border-amber-500/80 flex flex-col items-center justify-center p-3 text-center shadow-lg"
                  style={{ background: `radial-gradient(circle, #fef3c7 0%, ${design.accent_color}55 100%)` }}>
