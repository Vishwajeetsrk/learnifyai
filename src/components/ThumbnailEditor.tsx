...
const THEMES = [
  ...
  { id: "cyberpunk", label: "Cyberpunk", color: "rgba(236, 72, 153, 0.4)" },
  {
    id: "sunset",
    label: "Sunset",
    color: "linear-gradient(135deg, rgba(249,115,22,0.4), rgba(236,72,153,0.4))",
  },
...
export function ThumbnailEditor({
  ...
  const updateLayer = (id: string, updates: Partial<AnyLayer>) => {
    setLayers((prev) => prev.map((l) => (l.id === id ? { ...l, ...updates } : l)) as AnyLayer[]);
  };
  ...
  const duplicateLayer = (id: string) => {
    ...
    const clone = {
      ...target,
      id: generateId(),
      x: Number(target.x) + 40,
      y: Number(target.y) + 40,
      zIndex: layers.length + 1,
    };
        ...
        <div className="flex items-center justify-between px-4 py-2 border-b bg-muted/40 shrink-0">
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              size="icon"
              className="h-8 w-8"
              onClick={() => setWorkspaceZoom((z) => Math.max(0.1, z - 0.1))}
            >
              <ZoomOut className="h-4 w-4" />
            </Button>
            <div
              className="text-xs text-muted-foreground w-12 text-center select-none cursor-pointer hover:text-primary"
              onClick={() => setWorkspaceZoom(0.45)}
              title="Reset to Fit"
            >
            ...
            <Button
              ...
              size="icon"
              className="h-8 w-8"
              onClick={() => setWorkspaceZoom((z) => Math.min(3, z + 0.1))}
            >
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-16 border-r bg-muted/20 flex flex-col items-center py-4 gap-4 shrink-0 z-10">
            <Button
              variant="ghost"
              size="icon"
              className="h-10 w-10 flex-col gap-1"
              ...
              >
                ...
                {[...layers]
                  ...
                  .map((layer) => {
                    ...
                    if (layer.type === "image") {
                      ...
                      if (l.effect === "neon")
                        textShadow = `0 0 5px #fff, 0 0 10px #fff, 0 0 20px ${l.color}, 0 0 40px ${l.color}, 0 0 80px ${l.color}`;
                      if (l.effect === "3d")
                        textShadow = `1px 1px 0 #ccc, 2px 2px 0 #bbb, 3px 3px 0 #aaa, 4px 4px 0 #999, 5px 5px 0 #888, 6px 6px 20px rgba(0,0,0,0.5)`;
                    ...
                    return (
                      <Rnd
                        ...
                        className={
                          isSelected
                            ? "outline-dashed outline-2 outline-primary outline-offset-4 ring-4 ring-primary/20"
                            : ""
                        }
                ...
                {showSafeAreas && (
                  <div className="absolute inset-0 pointer-events-none z-[10000]">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 text-red-500/60 opacity-50">
                      +
                    </div>
                    {/* UI Margins */}
                    <div className="absolute top-0 bottom-0 right-[4%] border-l border-dashed border-blue-500/60" />
                    <span className="absolute top-2 left-2 text-[10px] text-red-500 bg-black/40 px-1 py-0.5 rounded">
                      Safe Area
                    </span>
                  </div>
                )}
                ...
                {!selectedLayer ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        value={bgState.theme}
                        onValueChange={(v) => setBgState({ ...bgState, theme: v })}
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <Slider
                        ...
                        max={100}
                        step={1}
                        value={[bgState.vignette]}
                        onValueChange={([v]) => setBgState({ ...bgState, vignette: v })}
                      />
                    </div>
                    ...
                    <div className="space-y-1">
                      {[...layers]
                        ...
                        .map((l) => (
                          <div
                            key={l.id}
                            className={`flex items-center justify-between p-2 rounded border text-xs cursor-pointer ${selectedId === l.id ? "bg-primary/10 border-primary" : "bg-muted/30 hover:bg-muted"}`}
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="space-y-1">
                        ...
                        <Input
                          type="number"
                          value={Math.round(Number(selectedLayer.x))}
                          onChange={(e) =>
                      ...
                      <div className="space-y-1">
                        ...
                        <Input
                          type="number"
                          value={Math.round(Number(selectedLayer.y))}
                          onChange={(e) =>
                      ...
                      <div className="space-y-1 col-span-2">
                        ...
                        <div className="flex items-center gap-2">
                          <Button
                            ...
                            onClick={() =>
                              updateLayer(selectedLayer.id, {
                                zIndex: Math.max(0, selectedLayer.zIndex - 1),
                              })
                            }
                          >
                            Move Back
                          ...
                          <Button
                            ...
                            className="h-8 px-2 flex-1 text-xs"
                            onClick={() =>
                              updateLayer(selectedLayer.id, { zIndex: selectedLayer.zIndex + 1 })
                            }
                          >
                            Move Forward
                          </Button>
                        ...
                        return (
                          <>
                            ...
                            <div className="space-y-2">
                              ...
                              <Select
                                value={l.fontFamily}
                                onValueChange={(v) => updateLayer(l.id, { fontFamily: v })}
                              >
                                <SelectTrigger>
                                  <SelectValue />
                                </SelectTrigger>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              <div className="space-y-1">
                                ...
                                <Input
                                  ...
                                  value={l.fontSize}
                                  onChange={(e) =>
                                    updateLayer(l.id, { fontSize: Number(e.target.value) })
                                  }
                                  className="h-8"
                                />
                              </div>
                              <div className="space-y-1">
                                ...
                                <Select
                                  value={l.fontWeight}
                                  onValueChange={(v) => updateLayer(l.id, { fontWeight: v })}
                                >
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="flex gap-1">
                                <Button
                                  variant={Number(l.fontWeight) >= 700 ? "default" : "outline"}
                                  size="icon"
                                  className="h-8 w-8"
                                  onClick={() =>
                                    updateLayer(l.id, {
                                      fontWeight: Number(l.fontWeight) >= 700 ? "400" : "900",
                                    })
                                  }
                                >
                                ...
                                <Button
                                  variant={l.fontStyle === "italic" ? "default" : "outline"}
                                  size="icon"
                                  className="h-8 w-8"
                                  onClick={() =>
                                    updateLayer(l.id, {
                                ...
                                <Button
                                  variant={l.textDecoration === "underline" ? "default" : "outline"}
                                  size="icon"
                                  className="h-8 w-8"
                                  onClick={() =>
                                    updateLayer(l.id, {
                                      textDecoration:
                                        l.textDecoration === "underline" ? "none" : "underline",
                                    })
                                  }
                                >
                                ...
                                <Button
                                  variant={
                                    l.textDecoration === "line-through" ? "default" : "outline"
                                  }
                                  size="icon"
                                  className="h-8 w-8"
                                  onClick={() =>
                                ...
                                {["🔥", "🚀", "💡", "⭐", "✅", "⚠️", "⚡", "✨", "❤️", "🎯"].map(
                                  (e) => (
                                    <Button
                                      ...
                                      size="sm"
                                      className="h-8 px-2"
                                      onClick={() => updateLayer(l.id, { text: l.text + e })}
                                    >
                                      {e}
                                    </Button>
                                  ),
                            ...
                            <div className="space-y-2">
                              ...
                              <Slider
                                ...
                                onValueChange={([v]) => updateLayer(l.id, { letterSpacing: v })}
                              />
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                              ...
                              <Select
                                value={l.effect}
                                onValueChange={(v: any) => updateLayer(l.id, { effect: v })}
                              >
                                <SelectTrigger>
                                  <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                                  {["none", "shadow", "glow", "outline", "neon", "3d"].map((e) => (
                          ...
                          <Tabs defaultValue="adjust" className="w-full">
                            ...
                            <TabsContent value="adjust" className="space-y-4 pt-2">
                              <div className="space-y-2">
                                ...
                                <Select
                                  value={l.fit}
                                  onValueChange={(v: any) => updateLayer(l.id, { fit: v })}
                                >
                                  <SelectTrigger>
                                    <SelectValue />
                                  </SelectTrigger>
                                  <SelectContent>
                                    {["cover", "contain", "fill"].map((e) => (
                                      <SelectItem key={e} value={e} className="capitalize">
                                        {e}
                                      </SelectItem>
                                    ))}
                              ...
                              <div className="flex gap-2 pt-2">
                                <Label className="flex items-center gap-2 text-xs">
                                  <Switch
                                    checked={l.flipH}
                                    onCheckedChange={(v) => updateLayer(l.id, { flipH: v })}
                                  />
                                  Flip Horizontal
                                </Label>
                              </div>
                              ...
                              {[
                                ...
                                <div key={filter.key} className="space-y-1">
                                  ...
                                  <Slider
                                    ...
                                    onValueChange={([v]) =>
                                      updateLayer(l.id, {
                                        filters: { ...l.filters, [filter.key]: v },
                                      })
                                    }
                                  />
                                </div>
