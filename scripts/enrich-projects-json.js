...
const TECH_MAP = {
  ...
  "aurora-signup": {
    tech: ["React 18", "TypeScript", "Motion 12", "Tailwind CSS v4"],
    ai: "Claude",
  },
  "auto-machines": {
    tech: ["React 19", "TypeScript", "Spline 3D", "Motion 12", "Tailwind CSS v4"],
    ai: "Lovable",
  },
  "axion-studio": {
    tech: ["React 18", "TypeScript", "WebGPU Shaders", "Tailwind CSS 3"],
    ai: "Antigravity",
  },
  "baby-track-automation": {
    tech: ["React 19", "TypeScript", "Motion 12", "Tailwind CSS v4"],
    ai: "Claude",
  },
  ...
  cognitra: {
    tech: ["React 18", "TypeScript", "Framer Motion 11", "Tailwind CSS 3"],
    ai: "Claude",
  },
  datacore: {
    tech: ["React 18", "TypeScript", "Framer Motion 11", "Tailwind CSS 3"],
  ...
  equilibrium: {
    tech: ["React 18", "TypeScript", "Framer Motion 11", "Tailwind CSS 3", "Geist Font"],
    ai: "Lovable",
  },
  "foundation-epoch": {
    tech: ["React 18", "TypeScript", "Motion 12", "Tailwind CSS v4", "clsx"],
    ai: "Antigravity",
  },
  ...
  "jack-3d-creator": {
    tech: ["React 18", "TypeScript", "Framer Motion 12", "Tailwind CSS 3"],
    ai: "Claude",
  },
  ...
  "unleash-scroll-hero": {
    tech: ["React 19", "TypeScript", "GSAP 3", "Motion 12", "hls.js", "Tailwind CSS v4"],
    ai: "Lovable",
  },
  vaultshield: {
    tech: ["React 18", "TypeScript", "Framer Motion 11", "Tailwind CSS 3"],
  ...
  "viralmedia-ai": {
    tech: ["React 18", "TypeScript", "Motion 12", "hls.js", "Tailwind CSS v4"],
    ai: "Antigravity",
  },
  wanderful: {
    tech: ["React 18", "TypeScript", "Framer Motion 12", "GSAP 3", "Tailwind CSS 3"],
    ai: "Claude",
  },
  "web3-eos": { tech: ["React 18", "TypeScript", "Tailwind CSS 3"], ai: "Lovable" },
  "zenith-realty": {
    tech: ["React 18", "TypeScript", "Motion 12", "Recharts 3", "Tailwind CSS 3"],
    ai: "Antigravity",
  },
};
